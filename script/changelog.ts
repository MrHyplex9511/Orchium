...
Generates UPCOMING_CHANGELOG.md by running the orchium changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for orchium run (default: low)
      --quiet            Suppress orchium command output unless it fails
