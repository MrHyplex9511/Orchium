...
- `Orchium` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `orchium` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Orchium` in prose, `orchium` only for exact technical identifiers
...
- Avoid changing `orchium` to `Orchium` inside commands, URLs, package names, or code literals
