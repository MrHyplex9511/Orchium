...
- `Orchium` (preserve casing in prose; keep `orchium` only when it is part of commands, package names, paths, or code)
- `Orchium Zen`
- `Orchium CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `orchium` in prose when referring to the product name; use `Orchium`
