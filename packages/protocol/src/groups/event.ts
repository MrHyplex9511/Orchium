...
import type { Definition } from "@orchium/schema/event"
...
export const OrchiumEvent = event.schema
export type OrchiumEvent = typeof OrchiumEvent.Type
export type OrchiumEventEncoded = typeof OrchiumEvent.Encoded
