...
import {
  ...
  type StatsModelData,
} from "@orchium/stats-core/domain/home"
import { statModel } from "@orchium/stats-core/domain/model-normalization"
...
export default function StatsModel() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="Orchium" />
      ...
      >
        {(data) => (
          <p data-slot="model-hero-rankline">
            ...
            <span data-slot="model-hero-pill">Orchium</span>
