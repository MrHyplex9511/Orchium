import orchiumWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/MrHyplex9511/Orchium",
  fallbackStars: "195K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "orchium:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://github.com/MrHyplex9511/Orchium">
            <strong>{i18n.t("header.tryOrchium")}</strong>
          </a>
          <button
...
function OrchiumMark() {
  return (
    <svg data-slot="orchium-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const connect = [
    { href: "https://discord.gg/SDyAKPEhN8", label: i18n.t("footer.community") },
    { href: "https://x.com/orchium", label: "X" },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://github.com/MrHyplex9511/Orchium" aria-label={i18n.t("footer.homeAria")}>
          <OrchiumMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={orchiumWordmarkDark} alt="Orchium" />
          <button
