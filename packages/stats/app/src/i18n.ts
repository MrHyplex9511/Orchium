...
const en = {
  "app.title": "AI Model Usage Rankings | Orchium Data",
  "app.description":
    "Explore Orchium usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Orchium Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Orchium on GitHub",
  "header.github": "GitHub",
  "header.tryOrchium": "Try Orchium",
  ...
  "home.topModelsDescription": "Usage of models across Orchium.",
  ...
  "home.uniqueUsersDescription": "Daily unique Orchium users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Orchium Data",
  "lab.description":
    "Compare {{lab}} models used in Orchium, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Orchium usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Orchium",
  ...
  "lab.shareOfUsage": "{{share}} of recent Orchium usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Orchium Data",
  "model.description":
    "View {{model}} Orchium usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Orchium usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Orchium usage",
  "model.ranked": "Ranked #{{rank}} across last week's Orchium usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Orchium usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Orchium usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No Orchium geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent Orchium token volume.",
