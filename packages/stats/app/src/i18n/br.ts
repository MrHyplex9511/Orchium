export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Orchium Data",
  "app.description":
    "Explore o uso do Orchium em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Orchium Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Orchium no GitHub",
  "header.github": "GitHub",
  "header.tryOrchium": "Experimente o Orchium",
  ...
  "footer.homeAria": "Início do Orchium",
  ...
  "modal.title": "Newsletter do Orchium",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Orchium.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Orchium por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Orchium Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Orchium, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Orchium.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Orchium",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Orchium",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Orchium nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Orchium Data",
  "model.description":
    "Veja dados de uso de {{model}} no Orchium, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Orchium aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Orchium da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Orchium da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Orchium na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Orchium, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Orchium.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Orchium na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Orchium na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Orchium.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do Orchium correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Orchium.",
