export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Orchium Data",
  "app.description":
    "Esplora l'utilizzo di Orchium nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Orchium Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Orchium su GitHub",
  "header.github": "GitHub",
  "header.tryOrchium": "Prova Orchium",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Orchium.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Orchium per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Orchium Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Orchium, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Orchium.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Orchium",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Orchium",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Orchium negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Orchium Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Orchium, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Orchium appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Orchium della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Orchium della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Orchium nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Orchium, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Orchium.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Orchium nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Orchium nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Orchium.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica Orchium corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token Orchium.",
