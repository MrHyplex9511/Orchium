export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | Orchium Data",
  "app.description":
    "Orchium kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde Orchium Data logosu",
  ...
  "header.githubAria": "GitHub'da Orchium'a yıldız ver",
  "header.github": "GitHub",
  "header.tryOrchium": "Orchium'u dene",
  ...
  "footer.homeAria": "Orchium ana sayfası",
  ...
  "home.topModelsDescription": "Orchium genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz Orchium kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | Orchium Data",
  "lab.description":
    "Orchium'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son Orchium kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "Orchium'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son Orchium kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük Orchium token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | Orchium Data",
  "model.description":
    "{{model}} için Orchium kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda Orchium kullanımı görünür.",
  "model.unranked": "Geçen haftaki Orchium kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki Orchium kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde Orchium kullanımı yok.",
  ...
  "model.overviewDescription": "Son Orchium tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz Orchium kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük Orchium token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz Orchium kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama Orchium oturum yapısı.",
  ...
  "model.noGeoDescription": "Bu modelle eşleşen Orchium coğrafi satırı yok.",
  "model.peersDescription": "Son Orchium token hacmine göre yakındaki modeller.",
