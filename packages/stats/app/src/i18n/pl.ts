export const dict = {
  "app.title": "Rankingi użycia modeli AI | Orchium Data",
  "app.description":
    "Przeglądaj użycie Orchium w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Orchium Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Orchium na GitHub",
  "header.github": "GitHub",
  "header.tryOrchium": "Wypróbuj Orchium",
  ...
  "footer.homeAria": "Strona główna Orchium",
  ...
  "home.topModelsDescription": "Użycie modeli w Orchium.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Orchium według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Orchium Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Orchium, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Orchium.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Orchium",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Orchium",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Orchium z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Orchium Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Orchium, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Orchium pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Orchium z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Orchium z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Orchium w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Orchium, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Orchium.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Orchium w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Orchium w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Orchium.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne Orchium nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Orchium.",
