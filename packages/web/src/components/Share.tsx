...
import { IconOrchium } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "orchium/session/message-v2"
import type { Message } from "orchium/session/message"
import type { Session } from "orchium/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.orchium_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.orchium_name}>
                    <IconOrchium width={16} height={16} />
                  </div>
