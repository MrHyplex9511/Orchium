---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala orchium.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

orchium zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie orchium uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI orchium, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do orchium. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij orchium. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `orchium.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo Orchium czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `orchium.default`.
