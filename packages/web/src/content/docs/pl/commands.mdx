...
Utwórz `.orchium/commands/test.md`:
...
Możesz zdefiniować polecenia w `orchium.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji orchium:
...
- Globalnie: `~/.config/orchium/commands/`
- Na projekt: `.orchium/commands/`
...
orchium zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
