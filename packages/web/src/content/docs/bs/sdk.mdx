---
title: SDK
description: Type-safe JS klijent za orchium server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

orchium JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje orchium-om.
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `orchium.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu orchium instancu, mozete napraviti klijentsku instancu i povezati se na nju:
