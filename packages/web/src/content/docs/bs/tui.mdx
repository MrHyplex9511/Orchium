---
title: TUI
description: Korištenje korisničkog interfejsa Orchium terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Orchium pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Orchium pokreće TUI za trenutni direktorij.
...
Kada koristite Orchium TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Orchium. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Orchium. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `orchium.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Orchium čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `orchium.default`.
