...
Kreiraj `.orchium/commands/test.md`:
...
Možete dodati prilagođene komande kroz Orchium konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Orchium [config](/docs/config):
...
- Globalno: `~/.config/orchium/commands/`
- Po projektu: `.orchium/commands/`
...
Orchium uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
