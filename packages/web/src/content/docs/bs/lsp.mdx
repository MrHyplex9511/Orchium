---
title: LSP serveri
description: Orchium se integriše sa vašim LSP serverima.
---

Orchium se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

Orchium dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `ORCHIUM_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i orchium otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj orchium konfiguraciji.
