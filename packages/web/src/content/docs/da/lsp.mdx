---
title: LSP-servere
description: Orchium integreres med dine LSP-servere.
---

Orchium kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Orchium leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `ORCHIUM_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og orchium åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din orchium-konfiguration.
