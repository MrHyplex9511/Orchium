...
Agentferdigheter lar Orchium oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går Orchium opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Orchium viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `orchium.json`:
