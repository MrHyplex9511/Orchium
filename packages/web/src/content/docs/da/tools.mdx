...
Her er alle de innebygde verktøyene som er tilgængelige i Orchium.
...
:::note
Dette verktøyet er bare tilgængelig når `ORCHIUM_EXPERIMENTAL_LSP_TOOL=true` (eller `ORCHIUM_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger Orchium-leverandøren eller når miljøvariabelen `ORCHIUM_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
