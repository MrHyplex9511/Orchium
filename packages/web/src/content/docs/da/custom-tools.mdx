...
description: Opret værktøjer, som LLM kan kalde orchium ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med orchiums [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.orchium/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/orchium/tools/`.
