---
title: Zen
description: Curated list of models provided by Orchium.
---
...
Orchium Zen is a list of tested and verified models provided by the Orchium team.

Zen works like any other provider in Orchium. You login to Orchium Zen and get
...
Orchium Zen is an AI gateway that gives you access to these models.

---

## How it works

Orchium Zen works like any other provider in Orchium.

1. You sign in to **<a href={console}>Orchium Zen</a>**, add your billing
   details, and copy your API key.
2. You run the `/connect` command in the TUI, select Orchium Zen, and paste your API key.
...
uses the format `orchium/<model-id>`. For example, for GPT 5.5, you would
use `orchium/gpt-5.5` in your config.
...
You may notice [low-cost models](/docs/config/#models), such as Haiku, Nano, or Flash, in your usage history. Orchium uses these models to generate session titles.
...
- MiMo-V2.5 Free is available on Orchium for a limited time. The team is using this time to collect feedback and improve the model.
- Ling 3.0 Flash Fin Free is available on Orchium for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3 Ultra Free is available on Orchium for a limited time. The team is using this time to collect feedback and improve the model.
- Nemotron 3.5 Lightning Free is available on Orchium for a limited time. The team is using this time to collect feedback and improve the model.
- Big Pickle is a stealth model that's free on Orchium for a limited time. The team is using this time to collect feedback and improve the model.
- Muse Spark 1.3 Contributor Free is available on Orchium for a limited time. The team is using this time to collect feedback and improve the model.
...
4. Have **no lock-in** by allowing you to use it with any other coding agent. And always let you use any other provider with Orchium as well.
