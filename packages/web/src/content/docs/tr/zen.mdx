---
title: Zen
description: orchium tarafından sağlanan seçilmiş modeller listesi.
---
...
Orchium Zen, Orchium ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, Orchium'daki diğer sağlayıcılar gibi çalışır. Orchium Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Orchium kullanmak için buna ihtiyacınız yoktur.
...
Orchium Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Orchium Zen, Orchium'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Orchium Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Orchium Zen'i seçin ve API anahtarınızı yapıştırın.
...
Orchium yapılandırmanızdaki [model id](/docs/config/#models) `orchium/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `orchium/gpt-5.5` kullanırsınız.
...
Kullanım geçmişinizde Haiku, Nano veya Flash gibi [düşük maliyetli modeller](/docs/config/#models) görebilirsiniz. Orchium, oturum başlıklarını oluşturmak için bu modelleri kullanır.
...
- MiMo-V2.5 Free, sınırlı bir süre için Orchium'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Ling 3.0 Flash Fin Free, sınırlı bir süre için Orchium'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için Orchium'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3.5 Lightning Free, sınırlı bir süre için Orchium'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Orchium'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Muse Spark 1.3 Contributor Free, sınırlı bir süre için Orchium'da kullanılabilir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Orchium Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Orchium ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
