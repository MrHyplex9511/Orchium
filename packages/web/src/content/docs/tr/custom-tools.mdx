---
title: Özel Araçlar
description: LLM'un orchium'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. orchium'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.orchium/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/orchium/tools/` içine yerleştirerek.
