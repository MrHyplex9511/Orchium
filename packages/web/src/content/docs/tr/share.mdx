---
title: Paylasim
description: orchium konusmalarini genel baglantilarla paylasin.
---

orchium'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda orchium:
...
orchium, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak orchium manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `orchium.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda orchium kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
