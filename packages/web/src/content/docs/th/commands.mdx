...
สร้าง `.orchium/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Orchium:
...
- ระดับผู้ใช้ (Global): `~/.config/orchium/commands/`
- ระดับโปรเจ็กต์: `.orchium/commands/`
...
Orchium มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
