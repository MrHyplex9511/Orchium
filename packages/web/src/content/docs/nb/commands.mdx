...
Opprett `.orchium/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Orchium-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Orchium [config](/docs/config):
...
Orchium inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
