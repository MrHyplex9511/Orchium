---
title: Zen
description: Utvalgt liste over modeller levert av Orchium.
---
...
Orchium Zen er en liste over testede og verifiserte modeller levert av Orchium-teamet.

Zen fungerer som enhver annen leverandør i Orchium. Du logger inn på Orchium Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Orchium.
:::
...
Orchium Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Orchium Zen fungerer som enhver annen leverandør i Orchium.

1. Du logger inn på **<a href={console}>Orchium Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Orchium Zen og limer inn API-nøkkelen din.
...
[modell-id](/docs/config/#models) i Orchium-konfigurasjonen din
bruker formatet `orchium/<model-id>`. For eksempel, for GPT 5.5, ville du
brukt `orchium/gpt-5.5` i konfigurasjonen din.
...
Du vil kanskje legge merke til [lavprismodeller](/docs/config/#models), som Haiku, Nano eller Flash, i brukshistorikken din. Orchium bruker disse modellene til å generere økttitler.
...
- MiMo-V2.5 Free er tilgjengelig på Orchium i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Ling 3.0 Flash Fin Free er tilgjengelig på Orchium i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Ultra Free er tilgjengelig på Orchium i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3.5 Lightning Free er tilgjengelig på Orchium i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Orchium i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Muse Spark 1.3 Contributor Free er tilgjengelig på Orchium i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
Vi opprettet Orchium Zen for å:
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Orchium også.
