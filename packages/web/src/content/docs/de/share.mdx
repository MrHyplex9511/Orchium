---
title: Teilen
description: Teile Orchium-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Orchium-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Orchium Folgendes:
...
Orchium hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Orchium den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`orchium.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du orchium in deiner Organisation einsetzt.
