...
Crear `.orchium/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración Orchium o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Orchium [config](/docs/config):
...
orchium incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
