...
Puoi aggiungere comandi personalizzati tramite la config di Orchium o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Orchium:
...
- Globale: `~/.config/orchium/commands/`
- Per progetto: `.orchium/commands/`
...
orchium include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
