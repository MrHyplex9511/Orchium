export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon Orchium ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "Orchiumning {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'orchium' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
