export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Orchium",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Orchium. ¿Quieres instalarla y reiniciar?",
