export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Orchium uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Orchium'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „orchium” kasutamiseks taaskäivitage terminal.",
