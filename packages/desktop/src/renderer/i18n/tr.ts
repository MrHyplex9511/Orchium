export const dict = {
  ...
  "desktop.updater.none.message": "Orchium'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "Orchium'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'orchium' komutunu kullanmak için terminalinizi yeniden başlatın.",
