export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Orchiumn uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Orchiumn versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Orchiumn uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'orchium'-komentoa.",
