export const dict = {
  ...
  "desktop.updater.none.message": "Orchium-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "Orchium-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'orchium' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
