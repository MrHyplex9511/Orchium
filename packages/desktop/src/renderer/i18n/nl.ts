export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Orchium",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Orchium is gedownload. Wil je deze installeren en Orchium opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'orchium' te gebruiken.",
