...
const releaseId = process.env.ORCHIUM_RELEASE
if (!releaseId) throw new Error("ORCHIUM_RELEASE is required")

const version = process.env.ORCHIUM_VERSION
if (!version) throw new Error("ORCHIUM_VERSION is required")
...
const macxTarGz = "orchium-desktop-mac-x64.app.tar.gz"
const macaTarGz = "orchium-desktop-mac-arm64.app.tar.gz"
