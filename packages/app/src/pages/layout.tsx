...
import { base64Encode } from "@orchium/core/util/encode"
...
import { Session } from "@orchium/sdk/v2/client"
...
import { retry } from "@orchium/core/util/retry"
...
import { useTheme, type ColorScheme } from "@orchium/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://github.com/MrHyplex9511/Orchium/issues")}
      renderPanel={() =>
