export const dict = {
  ...
  "desktop.menu.documentation": "Orchium دیاں دستاویزاں",
  ...
  "desktop.recovery.loadFailed": "Orchium لوڈ نئیں ہو سکیا",
  "desktop.recovery.terminated": "Orchium دی ونڈو اچانک بند ہو گئی",
  "desktop.recovery.unresponsive": "Orchium جواب نئیں دے رہیا",
  ...
  "desktop.wsl.error.installOrchium": "Orchium دی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ای شامل اے",
  "desktop.wsl.error.orchiumMissing": "اس ڈسٹرو وچ orchium انسٹال نئیں اے",
  "desktop.wsl.error.orchiumCannotRun": "orchium انسٹال اے پر چل نئیں سکیا",
  "desktop.wsl.error.orchiumNotInstalled": "{{distro}} وچ Orchium انسٹال نئیں اے",
  "desktop.wsl.error.updateVersion":
    "Orchium دی اپ ڈیٹ پوری ہو گئی پر {{distro}} ہلے وی {{installed}} دس رہیا اے؛ {{expected}} چاہیدا سی",
  ...
  "dialog.provider.orchium.note": "Claude، GPT، Gemini تے ہور سمیت کیوریٹڈ ماڈل",
  "dialog.provider.orchium.tagline": "قابل اعتماد اصلاح شدہ ماڈل",
  "dialog.provider.orchiumGo.tagline": "ہر اک لئی گھٹ قیمت دی رکنیت",
  ...
  "dialog.model.manage.context.label": "ਸੰਦਰਭ ਲੰਬਾਈ",
  "dialog.model.manage.context.placeholder": "ਸੰਦਰਭ ਲੰਬਾਈ",
  "dialog.model.manage.context.aria": "{{model}} ਲਈ ਸੰਦਰਭ ਲੰਬਾਈ",
  "dialog.model.unpaid.freeModels.title": "Orchium دے ذریعہ فراہم کردہ مفت ماڈل",
  ...
  "provider.connect.apiKey.description":
    "اپنے اکاؤنٹ نوں جوڑن لئی اپنی {{provider}} API کلید درج کرو تے Orchium وچ {{provider}} ماڈل ورتو۔",
  ...
  "provider.connect.orchiumZen.visit.prefix": "ویکھو ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " اپنی API کلید حاصل کرن لئی۔",
  "provider.connect.oauth.code.visit.prefix": "ویکھو ",
  "provider.connect.oauth.code.visit.link": "ایہہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    " اپنے اکاؤنٹ نوں جوڑن تے Orchium وچ {{provider}} ماڈل ورتن لئی اپنا اجازت کوڈ حاصل کرن لئی۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " تے اپنے اکاؤنٹ نوں جوڑن تے Orchium وچ {{provider}} ماڈل ورتن لئی تھلے دتا کوڈ درج کرو۔",
  ...
  "dialog.plugins.empty": "orchium.json وچ سیٹ کیتے پلگ اِن",
  ...
  "dialog.server.description": "ایہہ ایپ کس Orchium سرور نال جڑدی اے، اس نوں سوئچ کرو۔",
  ...
  "wsl.onboarding.checkingOrchium": "Orchium چیک کر رئے آں...",
  "wsl.onboarding.checkingOrchiumIn": "{{distro}} چ Orchium دی جانچ پڑتال...",
  "wsl.onboarding.updatingOrchium": "Orchium نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updatingOrchiumIn": "{{distro}} وچ Orchium نو اپ ڈیٹ کر رئے آں...",
  "wsl.onboarding.updateOrchiumIn": "{{distro}} وچ Orchium نو اپ ڈیٹ کرو۔",
  "wsl.onboarding.updateOrchium": "Orchium اپ ڈیٹ کرو",
  "wsl.onboarding.orchiumReadyIn": "Orchium {{distro}} چ تیار اے۔",
  "wsl.onboarding.orchiumReady": "Orchium تیار اے۔",
  "wsl.onboarding.installOrchiumIn": "{{distro}} وچ Orchium انسٹال کرو۔",
  "wsl.onboarding.installOrchium": "Orchium انسٹال کرو",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium انسٹال نئیں کیتا گیا",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Orchium دے WSL سرور شامل کرن توں پہلاں WSL (Windows Subsystem for Linux) دی لوڑ اے",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نئیں",
  "wsl.onboarding.wslUnavailable.description": "Orchium ایس مشین تے WSL دی تصدیق نئیں کر سکیا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کرو",
  "wsl.onboarding.windowsRestartRequired":
    "WSL دی تنصیب پوری کرن لئی Windows نوں دوبارہ شروع کرو، فیر Orchium دوبارہ کھولو۔",
  ...
  "help.tabs.introduction": "Orchium Desktop ہن ٹیباں دے گرد بنایا گیا اے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Orchium ({{version}}) دا اک نواں ورژن ہن انسٹال کرن لئی دستیاب اے۔",
  ...
  "error.page.report.prefix": "مہربانی کر کے اس غلطی دی اطلاع Orchium ٹیم نوں دیو",
  ...
  "error.chain.checkConfig": "اپنی کنفگ (orchium.json) وچ پرووائیڈر/ماڈل دے ناں چیک کرو",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Orchium ہلے تک MCP تصدیق دی حمایت نئیں کردا۔',
  ...
  "sidebar.gettingStarted.line1": "Orchium چ مفت ماڈل شامل نیں تاکہ تسی فوری طور تے شروع کر سکو۔",
  ...
  "settings.desktop.wsl.description": "Windows تے WSL دے اندر Orchium سرور چلاؤ۔",
  ...
  "settings.general.row.language.description": "Orchium لئی ڈسپلے دی بولی بدلو",
  ...
  "settings.general.row.appearance.description": "اپنے آلے تے Orchium کیویں لگدا اے، اپنی مرضی دے مطابق بناؤ",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description": "چنو کہ آیا Orchium سسٹم، لائٹ، یا ڈارک تھیم دی پیروی کردا اے",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Orchium نوں کس طرح تھیم کیتا گیا اے، اپنی مرضی دے مطابق بناؤ۔",
  ...
  "settings.updates.row.startup.description": "جدوں Orchium لانچ ہوندا اے تے خودبخود اپ ڈیٹس چیک کرو",
  ...
  "settings.updates.toast.latest.description": "تسی Orchium دا تازہ ترین ورژن چلا رئے او۔",
