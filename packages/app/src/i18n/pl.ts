export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Orchium",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Orchium",
  "desktop.recovery.terminated": "Okno Orchium zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Orchium nie odpowiada",
  ...
  "desktop.wsl.error.installOrchium": "Nie udało się zainstalować Orchium",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.orchiumMissing": "Program orchium nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.orchiumCannotRun": "Program orchium jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Orchium została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.orchium.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.orchium.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.orchiumGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.manage.context.label": "Długość kontekstu",
  "dialog.model.manage.context.placeholder": "Długość kontekstu",
  "dialog.model.manage.context.aria": "Długość kontekstu dla {{model}}",
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Orchium",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Odwiedź ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Orchium.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku orchium.json",
  ...
  "dialog.server.description": "Przełącz serwer Orchium, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOrchium": "Sprawdzanie Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Sprawdzanie Orchium w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Aktualizowanie Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Aktualizowanie Orchium w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Zaktualizuj Orchium w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOrchium": "Zaktualizuj Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium jest gotowy.",
  "wsl.onboarding.installOrchiumIn": "Zainstaluj Orchium w dystrybucji {{distro}}.",
  "wsl.onboarding.installOrchium": "Zainstaluj Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Orchium będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Orchium nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Orchium ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Orchium",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (orchium.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Orchium nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Orchium zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Orchium wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Orchium",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Orchium na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Orchium ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Orchium.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Orchium",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Orchium.",
