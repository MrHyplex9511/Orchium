export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Orchium",
  ...
  "desktop.menu.ariaLabel": "Menu do Orchium",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Orchium",
  "desktop.recovery.terminated": "A janela do Orchium foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Orchium não está respondendo",
  ...
  "desktop.wsl.error.installOrchium": "Falha na instalação do Orchium",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.orchiumMissing": "O orchium não está instalado nesta distribuição",
  "desktop.wsl.error.orchiumCannotRun": "O orchium está instalado, mas não pôde ser executado",
  "desktop.wsl.error.orchiumNotInstalled": "O Orchium não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Orchium foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.orchium.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.orchium.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.orchiumGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.manage.context.label": "Tamanho do contexto",
  "dialog.model.manage.context.placeholder": "Tamanho do contexto",
  "dialog.model.manage.context.aria": "Tamanho do contexto para {{model}}",
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Orchium",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.orchiumZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.orchiumZen.visit.prefix": "Visite ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Orchium.",
  ...
  "dialog.plugins.empty": "Plugins configurados em orchium.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Orchium este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOrchium": "Verificando o Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Verificando o Orchium em {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Atualizando o Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Atualizando o Orchium em {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Atualize o Orchium em {{distro}}.",
  "wsl.onboarding.updateOrchium": "Atualizar o Orchium",
  "wsl.onboarding.orchiumReadyIn": "O Orchium está pronto em {{distro}}.",
  "wsl.onboarding.orchiumReady": "O Orchium está pronto.",
  "wsl.onboarding.installOrchiumIn": "Instale o Orchium em {{distro}}.",
  "wsl.onboarding.installOrchium": "Instalar o Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Orchium possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Orchium não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Orchium novamente.",
  ...
  "help.tabs.introduction": "Agora, o Orchium Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Orchium ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Orchium",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (orchium.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Orchium ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Orchium dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Orchium",
  ...
  "settings.general.row.appearance.description": "Personalize como o Orchium aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Orchium segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Orchium é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Orchium iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Orchium.",
