export const dict = {
  ...
  "desktop.recovery.loadFailed": "Orchium kunde inte läsas in",
  "desktop.recovery.terminated": "Orchium-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Orchium svarar inte",
  ...
  "desktop.wsl.error.installOrchium": "Installationen av Orchium misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.orchiumMissing": "orchium är inte installerat i den här distributionen",
  "desktop.wsl.error.orchiumCannotRun": "orchium är installerat men kunde inte köras",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Orchium-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.orchium.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.orchium.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.orchiumGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.manage.context.label": "Kontextlängd",
  "dialog.model.manage.context.placeholder": "Kontextlängd",
  "dialog.model.manage.context.aria": "Kontextlängd för {{model}}",
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Orchium",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  "provider.connect.orchiumZen.line2":
    "Med en enda API-nyckel får du tillgång till modeller som Claude, GPT, Gemini, GLM och mer.",
  "provider.connect.orchiumZen.visit.prefix": "Besök ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Orchium.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i orchium.json",
  ...
  "dialog.server.description": "Växla vilken Orchium-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOrchium": "Kontrollerar Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Kontrollerar Orchium i {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Uppdaterar Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Uppdaterar Orchium i {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Uppdatera Orchium i {{distro}}.",
  "wsl.onboarding.updateOrchium": "Uppdatera Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium är redo i {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium är redo.",
  "wsl.onboarding.installOrchiumIn": "Installera Orchium i {{distro}}.",
  "wsl.onboarding.installOrchium": "Installera Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Orchium kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Orchium kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Orchium igen.",
  ...
  "help.tabs.introduction": "Orchium Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Orchium ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Orchium-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (orchium.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Orchium stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Orchium innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Orchium-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Orchium",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Orchium ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Orchium följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Orchiums tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Orchium startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Orchium.",
