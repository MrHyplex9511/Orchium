...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Orchium failed to load",
  "desktop.recovery.terminated": "Orchium window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Orchium is not responding",
  ...
  "desktop.wsl.error.installOrchium": "Orchium installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.orchiumMissing": "orchium is not installed in this distro",
  "desktop.wsl.error.orchiumCannotRun": "orchium is installed but could not run",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Orchium update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
