...
const desktop = [
  ...
  "Kilépés",
  "Az Orchium betöltése sikertelen",
  "Az Orchium ablaka váratlanul leállt",
  "Az Orchium nem válaszol",
  ...
  "Az Orchium telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az orchium nincs telepítve ebben a disztribúcióban",
  "Az orchium telepítve van, de nem futtatható",
  "Az Orchium nincs telepítve ebben: {{distro}}",
  "Az Orchium frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.orchium.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.orchium.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.orchiumGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.manage.context.label": "Kontextushossz",
  "dialog.model.manage.context.placeholder": "Kontextushossz",
  "dialog.model.manage.context.aria": "Kontextushossz ehhez: {{model}}",
  "dialog.model.unpaid.freeModels.title": "A Orchium ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a Orchium-ben.",
  ...
  "provider.connect.orchiumZen.line1":
    "A Orchium Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Látogatás",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a Orchium-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a Orchium-ben.",
  ...
  "dialog.plugins.empty": "Az orchium.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik Orchium szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOrchium": "Orchium ellenőrzése...",
  "wsl.onboarding.checkingOrchiumIn": "Orchium ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOrchium": "Orchium frissítése...",
  "wsl.onboarding.updatingOrchiumIn": "Orchium frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOrchiumIn": "Frissítse a Orchium-t a {{distro}}-ben.",
  "wsl.onboarding.updateOrchium": "Frissítse a Orchium-t",
  "wsl.onboarding.orchiumReadyIn": "A Orchium készen áll a {{distro}}-ben.",
  "wsl.onboarding.orchiumReady": "A Orchium készen áll.",
  "wsl.onboarding.installOrchiumIn": "Telepítse a Orchium-t a {{distro}}-be.",
  "wsl.onboarding.installOrchium": "Telepítse a Orchium-t",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "A Orchium nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a Orchium hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A Orchium nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a Orchium programot.",
  ...
  "help.tabs.introduction": "A Orchium Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A Orchium ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a Orchium csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (orchium.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a Orchium még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A Orchium ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "Orchium asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a Orchium szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a Orchium kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a Orchium az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a Orchium a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a Orchium témáját.",
  ...
  "settings.updates.row.startup.description": "A Orchium indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a Orchium legújabb verzióját futtatja.",
