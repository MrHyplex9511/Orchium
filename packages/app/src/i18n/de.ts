...
export const dict = {
  ...
  "dialog.provider.orchium.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.orchium.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.orchiumGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.manage.context.label": "Kontextlänge",
  "dialog.model.manage.context.placeholder": "Kontextlänge",
  "dialog.model.manage.context.aria": "Kontextlänge für {{model}}",
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Orchium",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Orchium zu nutzen.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Orchium zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Orchium zu nutzen.",
  ...
  "dialog.plugins.empty": "In orchium.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Orchium-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOrchium": "Orchium wird geprüft…",
  "wsl.onboarding.checkingOrchiumIn": "Orchium in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOrchium": "Orchium wird aktualisiert…",
  "wsl.onboarding.updatingOrchiumIn": "Orchium in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOrchiumIn": "Aktualisieren Sie Orchium in {{distro}}.",
  "wsl.onboarding.updateOrchium": "Orchium aktualisieren",
  "wsl.onboarding.orchiumReadyIn": "Orchium ist in {{distro}} bereit.",
  "wsl.onboarding.orchiumReady": "Orchium ist bereit.",
  "wsl.onboarding.installOrchiumIn": "Installieren Sie Orchium in {{distro}}.",
  "wsl.onboarding.installOrchium": "Orchium installieren",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Orchium einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Orchium konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Orchium erneut.",
  ...
  "toast.update.description": "Eine neue Version von Orchium ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Orchium-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (orchium.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Orchium unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Orchium mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "Orchium enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Orchium-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Orchium ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Orchium auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Orchium dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Orchium anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Orchium automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Orchium ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Orchium wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "Orchium konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Orchium-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Orchium reagiert nicht",
  ...
  "desktop.wsl.error.installOrchium": "Orchium-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.orchiumMissing": "orchium ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.orchiumCannotRun": "orchium ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Orchium-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Orchium Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
