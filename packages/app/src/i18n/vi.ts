export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Orchium",
  ...
  "desktop.recovery.loadFailed": "Không tải được Orchium",
  "desktop.recovery.terminated": "Cửa sổ Orchium đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Orchium không phản hồi",
  ...
  "desktop.wsl.error.installOrchium": "Không cài đặt được Orchium",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.orchiumMissing": "orchium chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.orchiumCannotRun": "orchium đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Orchium nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.orchium.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.orchium.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.orchiumGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.manage.context.label": "Độ dài ngữ cảnh",
  "dialog.model.manage.context.placeholder": "Độ dài ngữ cảnh",
  "dialog.model.manage.context.aria": "Độ dài ngữ cảnh cho {{model}}",
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Orchium cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Truy cập ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Orchium.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong orchium.json",
  ...
  "dialog.server.description": "Chuyển máy chủ Orchium mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOrchium": "Đang kiểm tra Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Đang kiểm tra Orchium trong {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Đang cập nhật Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Đang cập nhật Orchium trong {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Cập nhật Orchium trong {{distro}}.",
  "wsl.onboarding.updateOrchium": "Cập nhật Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium đã sẵn sàng.",
  "wsl.onboarding.installOrchiumIn": "Cài đặt Orchium trong {{distro}}.",
  "wsl.onboarding.installOrchium": "Cài đặt Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Orchium có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Orchium không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Orchium ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Orchium",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (orchium.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Orchium chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Orchium bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Orchium",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Orchium trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Orchium tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Orchium.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Orchium khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Orchium.",
