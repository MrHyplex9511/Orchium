export const dict = {
  ...
  "desktop.recovery.loadFailed": "Orchiumを読み込めませんでした",
  "desktop.recovery.terminated": "Orchiumのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Orchiumが応答していません",
  ...
  "desktop.wsl.error.installOrchium": "Orchiumのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.orchiumMissing": "このディストリビューションにはorchiumがインストールされていません",
  "desktop.wsl.error.orchiumCannotRun": "orchiumはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.orchiumNotInstalled": "{{distro}}にはOrchiumがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Orchiumのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.orchium.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.orchium.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.orchiumGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.manage.context.label": "コンテキスト長",
  "dialog.model.manage.context.placeholder": "コンテキスト長",
  "dialog.model.manage.context.aria": "{{model}} のコンテキスト長",
  "dialog.model.unpaid.freeModels.title": "Orchiumが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Orchiumで{{provider}}モデルを使用します。",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.orchiumZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.orchiumZen.visit.prefix": " ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してOrchiumで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Orchiumで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "orchium.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するOrchiumサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOrchium": "Orchiumを確認中...",
  "wsl.onboarding.checkingOrchiumIn": "{{distro}}内のOrchiumを確認中...",
  "wsl.onboarding.updatingOrchium": "Orchiumを更新中...",
  "wsl.onboarding.updatingOrchiumIn": "{{distro}}内のOrchiumを更新中...",
  "wsl.onboarding.updateOrchiumIn": "{{distro}}内のOrchiumを更新してください。",
  "wsl.onboarding.updateOrchium": "Orchiumを更新",
  "wsl.onboarding.orchiumReadyIn": "{{distro}}内のOrchiumの準備ができました。",
  "wsl.onboarding.orchiumReady": "Orchiumの準備ができました。",
  "wsl.onboarding.installOrchiumIn": "{{distro}}にOrchiumをインストールしてください。",
  "wsl.onboarding.installOrchium": "Orchiumをインストール",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchiumがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "OrchiumでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Orchiumをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Orchium Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Orchiumの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをOrchiumチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (orchium.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: OrchiumはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Orchiumには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でOrchiumサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Orchiumの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのOrchiumの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Orchiumがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Orchiumのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Orchium の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Orchium は最新バージョンです。",
