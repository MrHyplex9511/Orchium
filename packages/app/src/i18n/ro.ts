export const dict = {
  ...
  "desktop.menu.documentation": "Documentație Orchium",
  ...
  "desktop.menu.ariaLabel": "Meniu Orchium",
  ...
  "desktop.recovery.loadFailed": "Orchium nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra Orchium s-a închis neașteptat",
  "desktop.recovery.unresponsive": "Orchium nu răspunde",
  ...
  "desktop.wsl.error.installOrchium": "Instalarea Orchium a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.orchiumMissing": "orchium nu este instalat în această distribuție",
  "desktop.wsl.error.orchiumCannotRun": "orchium este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea Orchium s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.orchium.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.orchium.tagline": "Modele optimizate, fiabile",
  "dialog.provider.orchiumGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.manage.context.label": "Lungimea contextului",
  "dialog.model.manage.context.placeholder": "Lungimea contextului",
  "dialog.model.manage.context.aria": "Lungimea contextului pentru {{model}}",
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de Orchium",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.orchiumZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.orchiumZen.visit.prefix": "Vizitează",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în Orchium.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în orchium.json",
  ...
  "dialog.server.description": "Schimbă serverul Orchium la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOrchium": "Se verifică Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Se verifică Orchium în {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Se actualizează Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Se actualizează Orchium în {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Actualizează Orchium în {{distro}}.",
  "wsl.onboarding.updateOrchium": "Actualizează Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium este gata în {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium este gata.",
  "wsl.onboarding.installOrchiumIn": "Instalează Orchium în {{distro}}.",
  "wsl.onboarding.installOrchium": "Instalează Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca Orchium să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "Orchium nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune Orchium ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei Orchium",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (orchium.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, Orchium nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul Orchium în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru Orchium",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul Orchium pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă Orchium urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema Orchium.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea Orchium",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune Orchium.",
