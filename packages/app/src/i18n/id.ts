export const dict = {
  ...
  "desktop.recovery.loadFailed": "Orchium gagal dimuat",
  "desktop.recovery.terminated": "Jendela Orchium berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Orchium tidak merespons",
  ...
  "desktop.wsl.error.installOrchium": "Instalasi Orchium gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.orchiumMissing": "orchium belum terinstal di distro ini",
  "desktop.wsl.error.orchiumCannotRun": "orchium telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Orchium selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.orchium.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.orchium.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.orchiumGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Orchium.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di orchium.json",
  ...
  "dialog.server.description": "Ganti server Orchium mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOrchium": "Memeriksa Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Memeriksa Orchium di {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Memperbarui Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Memperbarui Orchium di {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Perbarui Orchium di {{distro}}.",
  "wsl.onboarding.updateOrchium": "Perbarui Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium siap di {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium siap.",
  "wsl.onboarding.installOrchiumIn": "Instal Orchium di {{distro}}.",
  "wsl.onboarding.installOrchium": "Instal Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Orchium dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Orchium tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Orchium ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Orchium",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (orchium.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Orchium belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Orchium di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Orchium",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Orchium di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Orchium mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Orchium diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Orchium.",
