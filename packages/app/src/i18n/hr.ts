...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Orchium se nije uspio učitati",
  "Prozor aplikacije Orchium neočekivano je zatvoren",
  "Orchium ne reagira",
  ...
  "Instalacija aplikacije Orchium nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "orchium nije instaliran u ovoj distribuciji",
  "orchium je instaliran, ali se ne može pokrenuti",
  "Orchium nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Orchium je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.orchium.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.orchium.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.orchiumGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.manage.context.label": "Duljina konteksta",
  "dialog.model.manage.context.placeholder": "Duljina konteksta",
  "dialog.model.manage.context.aria": "Duljina konteksta za {{model}}",
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Orchium",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Posjetiti",
  "provider.connect.orchiumZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Orchium.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u orchium.json",
  ...
  "dialog.server.description": "Promijenite na koji se Orchium poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOrchiumIn": "Provjera Orchium u {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Ažuriranje Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Ažuriranje Orchium u {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Ažurirajte Orchium u {{distro}}.",
  "wsl.onboarding.updateOrchium": "Ažurirajte Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium je spreman u {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium je spreman.",
  "wsl.onboarding.installOrchiumIn": "Instalirajte Orchium u {{distro}}.",
  "wsl.onboarding.installOrchium": "Instalirajte Orchium",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Orchium može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Orchium nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Orchium.",
  ...
  "help.tabs.introduction": "Radna površina Orchium sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Orchium ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Orchium timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (orchium.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Orchium još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Orchium uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Orchium Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Orchium poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Orchium",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Orchium izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Orchium slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Orchium tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Orchium pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Orchium.",
