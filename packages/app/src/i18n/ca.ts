export const dict = {
  ...
  "desktop.menu.documentation": "Orchium Documentació",
  ...
  "desktop.menu.ariaLabel": "menú Orchium.",
  ...
  "desktop.recovery.loadFailed": "Orchium no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra Orchium s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "Orchium no respon",
  ...
  "desktop.wsl.error.installOrchium": "La instal·lació de Orchium ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.orchiumMissing": "orchium no està instal·lat en aquesta distribució",
  "desktop.wsl.error.orchiumCannotRun": "orchium està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Orchium actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.orchium.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.orchium.tagline": "Models optimitzats fiables",
  "dialog.provider.orchiumGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.manage.context.label": "Longitud del context",
  "dialog.model.manage.context.placeholder": "Longitud del context",
  "dialog.model.manage.context.aria": "Longitud del context per a {{model}}",
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per Orchium",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.orchiumZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a Orchium.",
  ...
  "dialog.plugins.empty": "Connectors configurats a orchium.json",
  ...
  "dialog.server.description": "Canvia a quin Orchium servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOrchium": "S'està comprovant Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "S'està registrant Orchium a {{distro}}...",
  "wsl.onboarding.updatingOrchium": "S'està actualitzant Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "S'està actualitzant Orchium a {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Actualitza Orchium a {{distro}}.",
  "wsl.onboarding.updateOrchium": "Actualització Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium està llest a {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium està llest.",
  "wsl.onboarding.installOrchiumIn": "Instal·leu Orchium a {{distro}}.",
  "wsl.onboarding.installOrchium": "Instal·la Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que Orchium pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Orchium no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir Orchium.",
  ...
  "help.tabs.introduction": "Orchium L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de Orchium ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip Orchium.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (orchium.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que Orchium encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "Orchium Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor Orchium dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a Orchium",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu Orchium al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si Orchium segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de Orchium.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï Orchium.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de Orchium.",
