export const dict = {
  ...
  "dialog.provider.orchium.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.orchium.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.orchiumGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.manage.context.label": "Lunghezza contesto",
  "dialog.model.manage.context.placeholder": "Lunghezza contesto",
  "dialog.model.manage.context.aria": "Lunghezza contesto per {{model}}",
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Orchium",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.orchiumZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.orchiumZen.visit.prefix": "Visita ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in Orchium.",
  ...
  "dialog.plugins.empty": "Plugin configurati in orchium.json",
  ...
  "dialog.server.description": "Cambia il server Orchium a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOrchium": "Controllo Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Controllo Orchium in {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Aggiornamento Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Aggiornamento Orchium in {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Aggiorna Orchium in {{distro}}.",
  "wsl.onboarding.updateOrchium": "Aggiorna Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium è pronto in {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium è pronto.",
  "wsl.onboarding.installOrchiumIn": "Installa Orchium in {{distro}}.",
  "wsl.onboarding.installOrchium": "Installa Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che Orchium possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "Orchium non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di Orchium ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Orchium",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (orchium.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: Orchium non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server Orchium all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per Orchium",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Orchium sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se Orchium segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Orchium.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di Orchium",
  ...
  "settings.updates.toast.latest.title": "Orchium è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di Orchium.",
  ...
  "desktop.menu.documentation": "Documentazione di Orchium",
  ...
  "desktop.menu.ariaLabel": "Menu Orchium",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare Orchium",
  "desktop.recovery.terminated": "La finestra di Orchium si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "Orchium non risponde",
  ...
  "desktop.wsl.error.installOrchium": "Installazione di Orchium non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.orchiumMissing": "orchium non è installato in questa distribuzione",
  "desktop.wsl.error.orchiumCannotRun": "orchium è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di Orchium è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
