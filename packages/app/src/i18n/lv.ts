export const dict = {
  ...
  "desktop.menu.documentation": "Orchium dokumentācija",
  ...
  "desktop.menu.ariaLabel": "Orchium izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt Orchium",
  "desktop.recovery.terminated": "Orchium logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "Orchium neatbild",
  ...
  "desktop.wsl.error.installOrchium": "Orchium instalēšana neizdevās",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau ir pievienota",
  "desktop.wsl.error.orchiumMissing": "orchium nav instalēts šajā distribūcijā",
  "desktop.wsl.error.orchiumCannotRun": "orchium ir instalēts, bet to nevar palaist",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium nav instalēts {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Orchium atjaunināšana pabeigta, bet {{distro}} joprojām rāda {{installed}}; gaidīts {{expected}}",
  ...
  "dialog.provider.orchium.note": "Atlasīti modeļi, tostarp Claude, GPT, Gemini un citi",
  "dialog.provider.orchium.tagline": "Uzticami optimizēti modeļi",
  "dialog.provider.orchiumGo.tagline": "Zemas cenas abonements visiem",
  ...
  "dialog.model.manage.context.label": "Konteksta garums",
  "dialog.model.manage.context.placeholder": "Konteksta garums",
  "dialog.model.manage.context.aria": "Konteksta garums — {{model}}",
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no Orchium",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen nodrošina piekļuvi atlasītiem uzticamiem optimizētiem modeļiem kodēšanas aģentiem.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Apmeklējiet",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": ", lai saņemtu savu API atslēgu.",
  "provider.connect.oauth.code.visit.prefix": "Apmeklējiet",
  "provider.connect.oauth.code.visit.link": "šo saiti",
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus Orchium.",
  ...
  "dialog.plugins.empty": "Spraudņi konfigurēti orchium.json",
  ...
  "dialog.server.description": "Mainiet, pie kura Orchium servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOrchium": "Pārbaudu Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Pārbaudu Orchium distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Atjauninu Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Atjauninu Orchium distribūcijā {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Atjauniniet Orchium distribūcijā {{distro}}.",
  "wsl.onboarding.updateOrchium": "Atjauniniet Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium ir gatavs.",
  "wsl.onboarding.installOrchiumIn": "Instalējiet Orchium distribūcijā {{distro}}.",
  "wsl.onboarding.installOrchium": "Instalējiet Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms Orchium var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "Orchium neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet Orchium no jauna.",
  ...
  "help.tabs.introduction": "Orchium Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna Orchium versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu Orchium komandai",
  ...
  "error.chain.checkConfig": "Pārbaudiet konfigurāciju (orchium.json) pakalpojuma/modela nosaukumus",
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, Orchium vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "Orchium ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "Orchium darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist Orchium serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt Orchium saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā Orchium izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai Orchium sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet Orchium tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot Orchium",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko Orchium versiju.",
