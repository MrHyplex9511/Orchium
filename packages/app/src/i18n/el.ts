export const dict = {
  ...
  "desktop.menu.documentation": "Orchium Τεκμηρίωση",
  ...
  "desktop.menu.ariaLabel": "Orchium μενού",
  ...
  "desktop.recovery.loadFailed": "Orchium απέτυχε η φόρτωση",
  "desktop.recovery.terminated": "Orchium το παράθυρο τερματίστηκε απροσδόκητα",
  "desktop.recovery.unresponsive": "Orchium δεν αποκρίνεται",
  ...
  "desktop.wsl.error.installOrchium": "Orchium η εγκατάσταση απέτυχε",
  "desktop.wsl.error.alreadyAdded": "{{distro}} έχει ήδη προστεθεί",
  "desktop.wsl.error.orchiumMissing": "ο ανοιχτός κώδικας δεν είναι εγκατεστημένος σε αυτήν τη διανομή",
  "desktop.wsl.error.orchiumCannotRun": "ο ανοιχτός κώδικας είναι εγκατεστημένος αλλά δεν ήταν δυνατή η εκτέλεση",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium δεν είναι εγκατεστημένο στο {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Orchium η ενημέρωση ολοκληρώθηκε αλλά το {{distro}} εξακολουθεί να αναφέρει {{installed}}; αναμενόμενο {{expected}}",
  ...
  "dialog.provider.orchium.note": "Επιμελημένα μοντέλα συμπεριλαμβανομένων των Claude, GPT, Gemini και άλλων",
  "dialog.provider.orchium.tagline": "Αξιόπιστα βελτιστοποιημένα μοντέλα",
  "dialog.provider.orchiumGo.tagline": "Συνδρομή χαμηλού κόστους για όλους",
  ...
  "dialog.model.manage.context.label": "Μήκος περιβάλλοντος",
  "dialog.model.manage.context.placeholder": "Μήκος περιβάλλοντος",
  "dialog.model.manage.context.aria": "Μήκος περιβάλλοντος για {{model}}",
  "dialog.model.unpaid.freeModels.title": "Δωρεάν μοντέλα παρέχονται από Orchium",
  ...
  "provider.connect.apiKey.description":
    "Εισαγάγετε το κλειδί {{provider}} API για να συνδέσετε τον λογαριασμό σας και χρησιμοποιήστε μοντέλα {{provider}} στο Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Το Zen σάς δίνει πρόσβαση σε ένα επιμελημένο σύνολο αξιόπιστων βελτιστοποιημένων μοντέλων για πράκτορες κωδικοποίησης.",
  "provider.connect.orchiumZen.line2":
    "Με ένα μόνο κλειδί API θα έχετε πρόσβαση σε μοντέλα όπως Claude, GPT, Gemini, GLM και άλλα.",
  "provider.connect.orchiumZen.visit.prefix": "Επίσκεψη ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " για τη συλλογή του κλειδιού σας API.",
  "provider.connect.oauth.code.visit.prefix": "Επίσκεψη ",
  "provider.connect.oauth.code.visit.link": "αυτός ο σύνδεσμος",
  "provider.connect.oauth.code.visit.suffix":
    " για να συλλέξετε τον κωδικό εξουσιοδότησης για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " και εισαγάγετε τον παρακάτω κωδικό για να συνδέσετε τον λογαριασμό σας και να χρησιμοποιήσετε {{provider}} μοντέλα στο Orchium.",
  ...
  "dialog.plugins.empty": "Προσθήκες ρυθμισμένες στο orchium.json",
  ...
  "dialog.server.description": "Αλλαγή σε ποιον διακομιστή Orchium συνδέεται αυτή η εφαρμογή.",
  ...
  "wsl.onboarding.checkingOrchium": "Έλεγχος Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Έλεγχος Orchium σε {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Ενημέρωση Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Ενημέρωση Orchium σε {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Ενημέρωση Orchium σε {{distro}}.",
  "wsl.onboarding.updateOrchium": "Ενημέρωση Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium είναι έτοιμο στο {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium είναι έτοιμο.",
  "wsl.onboarding.installOrchiumIn": "Εγκατάσταση του Orchium στο {{distro}}.",
  "wsl.onboarding.installOrchium": "Εγκατάσταση Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium δεν έχει εγκατασταθεί",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Υποσύστημα για Linux) απαιτείται για να μπορέσει ο Orchium να προσθέσει έναν διακομιστή WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL μη διαθέσιμο",
  "wsl.onboarding.wslUnavailable.description": "Orchium δεν μπόρεσε να επαληθεύσει το WSL σε αυτό το μηχάνημα.",
  "wsl.onboarding.installWsl": "Εγκατάσταση WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Επανεκκινήστε το Windows για να ολοκληρώσετε την εγκατάσταση του WSL και μετά ανοίξτε ξανά το Orchium.",
  ...
  "help.tabs.introduction": "Orchium Η επιφάνεια εργασίας είναι πλέον χτισμένη γύρω από καρτέλες.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Μια νέα έκδοση του Orchium ({{version}}) είναι τώρα διαθέσιμη για εγκατάσταση.",
  ...
  "error.page.report.prefix": "Αναφέρετε αυτό το σφάλμα στην ομάδα Orchium",
  ...
  "error.chain.checkConfig": "Ελέγξτε τη διαμόρφωση (orchium.json) ονόματα παρόχου/μοντέλων",
  "error.chain.mcpFailed":
    'MCP διακομιστής "{{name}}" απέτυχε. Σημείωση, το Orchium δεν υποστηρίζει ακόμη έλεγχο ταυτότητας MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium περιλαμβάνει δωρεάν μοντέλα, ώστε να μπορείτε να ξεκινήσετε αμέσως.",
  ...
  "app.name.desktop": "Orchium Επιτραπέζιος υπολογιστής",
  ...
  "settings.desktop.wsl.description": "Εκτέλεση του διακομιστή Orchium μέσα στο WSL στο Windows.",
  ...
  "settings.general.row.language.description": "Αλλαγή της γλώσσας εμφάνισης για το Orchium",
  ...
  "settings.general.row.appearance.description": "Προσαρμογή της εμφάνισης του Orchium στη συσκευή σας",
  "settings.general.row.colorScheme.title": "Χρωματικός συνδυασμός",
  "settings.general.row.colorScheme.description":
    "Επιλέξτε εάν το Orchium ακολουθεί το σύστημα, το ανοιχτό ή το σκοτεινό θέμα",
  "settings.general.row.theme.title": "Θέμα",
  "settings.general.row.theme.description": "Προσαρμογή του τρόπου με τον οποίο έχει θέμα το Orchium.",
  ...
  "settings.updates.row.startup.description": "Αυτόματος έλεγχος για ενημερώσεις κατά την εκκίνηση του Orchium",
  ...
  "settings.updates.toast.latest.description": "Εκτελείτε την πιο πρόσφατη έκδοση του Orchium.",
