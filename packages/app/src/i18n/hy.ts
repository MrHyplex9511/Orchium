export const dict = {
  ...
  "desktop.menu.documentation": "Orchium Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Orchium մենյու",
  ...
  "desktop.recovery.loadFailed": "Orchium չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Orchium պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Orchium-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOrchium": "Orchium տեղադրումը ձախողվեց",
  "desktop.wsl.error.alreadyAdded": "{{distro}} արդեն ավելացված է",
  "desktop.wsl.error.orchiumMissing": "orchium-ը տեղադրված չէ այս բաշխում",
  "desktop.wsl.error.orchiumCannotRun": "orchium-ը տեղադրված է, բայց չի կարող գործարկվել",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Orchium թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.provider.orchium.note": "Ընտրված մոդելներ, ներառյալ՝ Claude, GPT, Gemini և ավելին",
  "dialog.provider.orchium.tagline": "Վստահելի օպտիմիզացված մոդելներ",
  "dialog.provider.orchiumGo.tagline": "Ցածր գնով բաժանորդագրություն բոլորի համար",
  ...
  "dialog.model.manage.context.label": "Համատեքստի երկարություն",
  "dialog.model.manage.context.placeholder": "Համատեքստի երկարություն",
  "dialog.model.manage.context.aria": "Համատեքստի երկարություն {{model}}-ի համար",
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Orchium",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Orchium-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen-ը թույլ է տալիս մուտք գործել կոդավորման գործակալների համար հուսալի օպտիմիզացված մոդելների հավաքածու։",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Այցելություն ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " ձեր API բանալին հավաքելու համար",
  "provider.connect.oauth.code.visit.prefix": "Այցելություն ",
  "provider.connect.oauth.code.visit.link": "այս հղումը",
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Orchium-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Orchium-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.plugins.empty": "Ընդլայնումները կազմաձևված են orchium.json-ում",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Orchium սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOrchium": "Ստուգում է Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Ստուգում է Orchium-ը {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Թարմացվում է Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Թարմացվում է Orchium-ը {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Թարմացնել Orchium-ը {{distro}}-ում։",
  "wsl.onboarding.updateOrchium": "Թարմացնել Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.orchiumReady": "Orchium պատրաստ է։",
  "wsl.onboarding.installOrchiumIn": "Տեղադրեք Orchium-ը {{distro}}-ում։",
  "wsl.onboarding.installOrchium": "Տեղադրեք Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Orchium-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Orchium-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Orchium։",
  ...
  "help.tabs.introduction": "Orchium Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Orchium-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Orchium թիմին",
  ...
  "error.chain.checkConfig": "Ստուգեք ձեր կազմաձևը (orchium.json) մատակարարի/մոդելի անունները",
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Orchium-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Orchium ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Orchium սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Orchium",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Orchium տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Orchium-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Orchium-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Orchium-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Orchium-ի վերջին տարբերակը։",
