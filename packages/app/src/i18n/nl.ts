export const dict = {
  ...
  "desktop.menu.documentation": "Orchium-documentatie",
  ...
  "desktop.recovery.loadFailed": "Orchium kan niet worden geladen",
  "desktop.recovery.terminated": "Het Orchium-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Orchium reageert niet",
  ...
  "desktop.wsl.error.installOrchium": "Installatie van Orchium is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.orchiumMissing": "orchium is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.orchiumCannotRun": "orchium is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Orchium-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.orchium.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.orchium.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.orchiumGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.manage.context.label": "Contextlengte",
  "dialog.model.manage.context.placeholder": "Contextlengte",
  "dialog.model.manage.context.aria": "Contextlengte voor {{model}}",
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Orchium",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Orchium te gebruiken.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  "provider.connect.orchiumZen.line2":
    "Met één API-sleutel krijg je toegang tot modellen zoals Claude, GPT, Gemini, GLM en meer.",
  "provider.connect.orchiumZen.visit.prefix": "Ga naar ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Orchium te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Orchium te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in orchium.json",
  ...
  "dialog.server.description": "Wijzig met welke Orchium-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOrchium": "Orchium controleren...",
  "wsl.onboarding.checkingOrchiumIn": "Orchium controleren in {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Orchium bijwerken...",
  "wsl.onboarding.updatingOrchiumIn": "Orchium bijwerken in {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Werk Orchium bij in {{distro}}.",
  "wsl.onboarding.updateOrchium": "Orchium bijwerken",
  "wsl.onboarding.orchiumReadyIn": "Orchium is gereed in {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium is klaar.",
  "wsl.onboarding.installOrchiumIn": "Installeer Orchium in {{distro}}.",
  "wsl.onboarding.installOrchium": "Installeer Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Orchium een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Orchium kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Orchium opnieuw.",
  ...
  "help.tabs.introduction": "Orchium Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Orchium ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Orchium-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (orchium.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Orchium ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Orchium bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Orchium-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Orchium",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Orchium eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Orchium het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Orchium aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Orchium wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Orchium is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Orchium.",
