export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Orchium",
  "desktop.recovery.terminated": "توقفت نافذة Orchium بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Orchium لا يستجيب",
  ...
  "desktop.wsl.error.installOrchium": "فشل تثبيت Orchium",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.orchiumMissing": "orchium غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.orchiumCannotRun": "orchium مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Orchium، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.orchium.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.orchium.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.orchiumGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.manage.context.label": "طول السياق",
  "dialog.model.manage.context.placeholder": "طول السياق",
  "dialog.model.manage.context.aria": "طول سياق {{model}}",
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Orchium",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "يمنحك Orchium Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "قم بزيارة ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Orchium.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في orchium.json",
  ...
  "dialog.server.description": "تبديل خادم Orchium الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOrchium": "جارٍ التحقق من Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "جارٍ التحقق من Orchium في {{distro}}...",
  "wsl.onboarding.updatingOrchium": "جارٍ تحديث Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "جارٍ تحديث Orchium في {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "حدّث Orchium في {{distro}}.",
  "wsl.onboarding.updateOrchium": "تحديث Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium جاهز في {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium جاهز.",
  "wsl.onboarding.installOrchiumIn": "ثبّت Orchium في {{distro}}.",
  "wsl.onboarding.installOrchium": "تثبيت Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Orchium من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Orchium التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Orchium.",
  ...
  "help.tabs.introduction": "أصبح Orchium Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Orchium ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Orchium",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (orchium.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Orchium لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Orchium نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Orchium داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Orchium",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Orchium على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Orchium يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Orchium.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Orchium",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Orchium.",
