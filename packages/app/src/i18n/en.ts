...
export const dict = {
  ...
  "dialog.provider.orchium.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.orchium.tagline": "Reliable optimized models",
  "dialog.provider.orchiumGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.manage.context.label": "Context length",
  "dialog.model.manage.context.placeholder": "Context length",
  "dialog.model.manage.context.aria": "Context length for {{model}}",

  "dialog.model.unpaid.freeModels.title": "Free models provided by Orchium",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Orchium.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.orchiumZen.line1":
    "Orchium Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.orchiumZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.orchiumZen.visit.prefix": "Visit ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Orchium.",
  ...
  "dialog.plugins.empty": "Plugins configured in orchium.json",
  ...
  "dialog.server.description": "Switch which Orchium server this app connects to.",
  ...
  "wsl.onboarding.checkingOrchium": "Checking Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Checking Orchium in {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Updating Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Updating Orchium in {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Update Orchium in {{distro}}.",
  "wsl.onboarding.updateOrchium": "Update Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium is ready in {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium is ready.",
  "wsl.onboarding.installOrchiumIn": "Install Orchium in {{distro}}.",
  "wsl.onboarding.installOrchium": "Install Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Orchium can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Orchium could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Orchium ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Orchium team",
  ...
  "error.chain.checkConfig": "Check your config (orchium.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Orchium does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Orchium includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Orchium server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Orchium",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Orchium looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Orchium follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Orchium is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Orchium launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Orchium.",
