export const dict = {
  ...
  "desktop.menu.documentation": "Документація Orchium",
  ...
  "desktop.menu.ariaLabel": "Меню Orchium",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити Orchium",
  "desktop.recovery.terminated": "Роботу вікна Orchium несподівано завершено",
  "desktop.recovery.unresponsive": "Orchium не відповідає",
  ...
  "desktop.wsl.error.installOrchium": "Не вдалося встановити Orchium",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.orchiumMissing": "orchium не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.orchiumCannotRun": "orchium встановлено, але його не вдалося запустити",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення Orchium завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.orchium.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.orchium.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.orchiumGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.manage.context.label": "Довжина контексту",
  "dialog.model.manage.context.placeholder": "Довжина контексту",
  "dialog.model.manage.context.aria": "Довжина контексту для {{model}}",

  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Orchium",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Відвідайте ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у Orchium.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в orchium.json",
  ...
  "dialog.server.description": "Перемкніть сервер Orchium, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOrchium": "Перевірка Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Перевірка Orchium у {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Оновлення Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Оновлення Orchium у {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Оновіть Orchium у {{distro}}.",
  "wsl.onboarding.updateOrchium": "Оновити Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium готовий до роботи у {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium готовий до роботи.",
  "wsl.onboarding.installOrchiumIn": "Встановіть Orchium у {{distro}}.",
  "wsl.onboarding.installOrchium": "Встановити Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в Orchium потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Orchium не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія Orchium ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Orchium",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (orchium.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, Orchium ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер Orchium всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу Orchium",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд Orchium на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи Orchium використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему Orchium.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску Orchium",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію Orchium.",
