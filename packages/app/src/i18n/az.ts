export const dict = {
  ...
  "desktop.recovery.loadFailed": "Orchium yüklənə bilmədi",
  "desktop.recovery.terminated": "Orchium pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Orchium cavab vermir",
  ...
  "desktop.wsl.error.installOrchium": "Orchium quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.orchiumMissing": "Bu distribütivdə orchium quraşdırılmayıb",
  "desktop.wsl.error.orchiumCannotRun": "orchium quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Orchium yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.orchium.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.orchium.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.orchiumGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.manage.context.label": "Kontekst uzunluğu",
  "dialog.model.manage.context.placeholder": "Kontekst uzunluğu",
  "dialog.model.manage.context.aria": "{{model}} üçün kontekst uzunluğu",
  "dialog.model.unpaid.freeModels.title": "Orchium tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Orchium-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Orchium-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Orchium-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər orchium.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Orchium serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOrchium": "Orchium yoxlanılır...",
  "wsl.onboarding.checkingOrchiumIn": "{{distro}}-də Orchium yoxlanılır...",
  "wsl.onboarding.updatingOrchium": "Orchium yenilənir...",
  "wsl.onboarding.updatingOrchiumIn": "{{distro}}-də Orchium yenilənir...",
  "wsl.onboarding.updateOrchiumIn": "{{distro}}-də Orchium-u yeniləyin.",
  "wsl.onboarding.updateOrchium": "Orchium-u yeniləyin",
  "wsl.onboarding.orchiumReadyIn": "Orchium {{distro}}-də hazırdır.",
  "wsl.onboarding.orchiumReady": "Orchium hazırdır.",
  "wsl.onboarding.installOrchiumIn": "Orchium-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOrchium": "Orchium quraşdırın",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Orchium WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Orchium bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Orchium-u yenidən açın.",
  ...
  "help.tabs.introduction": "Orchium Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Orchium-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Orchium komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (orchium.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Orchium hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Orchium-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Orchium serverini işlət.",
  ...
  "settings.general.row.language.description": "Orchium üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Orchium-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Orchium-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Orchium-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Orchium açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Orchium-un ən son versiyasından istifadə edirsiniz.",
