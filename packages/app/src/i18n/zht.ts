...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Orchium 載入失敗",
  "desktop.recovery.terminated": "Orchium 視窗意外終止",
  "desktop.recovery.unresponsive": "Orchium 沒有回應",
  ...
  "desktop.wsl.error.installOrchium": "Orchium 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.orchiumMissing": "此發行版中未安裝 orchium",
  "desktop.wsl.error.orchiumCannotRun": "已安裝 orchium，但無法執行",
  "desktop.wsl.error.orchiumNotInstalled": "{{distro}} 中未安裝 Orchium",
  "desktop.wsl.error.updateVersion":
    "Orchium 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.orchium.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.orchium.tagline": "經過最佳化的可靠模型",
  "dialog.provider.orchiumGo.tagline": "適合所有人的低成本訂閱",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Orchium 中使用 {{provider}} 模型。",
  ...
  "provider.connect.orchiumZen.line1": "Orchium Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.orchiumZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.orchiumZen.visit.prefix": "造訪 ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Orchium 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Orchium 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 orchium.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Orchium 伺服器。",
  ...
  "wsl.onboarding.checkingOrchium": "正在檢查 Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "正在檢查 {{distro}} 中的 Orchium...",
  ...
  "wsl.onboarding.orchiumReadyIn": "{{distro}} 中的 Orchium 已就緒。",
  "wsl.onboarding.orchiumReady": "Orchium 已就緒。",
  "wsl.onboarding.installOrchiumIn": "在 {{distro}} 中安裝 Orchium。",
  "wsl.onboarding.installOrchium": "安裝 Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "未安裝 Orchium",
  ...
  "wsl.onboarding.wslUnavailable.description": "Orchium 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Orchium。",
  ...
  "help.tabs.introduction": "Orchium Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Orchium 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Orchium 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (orchium.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Orchium 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "Orchium 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Orchium 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Orchium 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Orchium 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Orchium 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Orchium 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Orchium 啟動時自動檢查更新",
