export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Orchium",
  ...
  "desktop.menu.ariaLabel": "Menú de Orchium",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Orchium",
  "desktop.recovery.terminated": "La ventana de Orchium se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Orchium no responde",
  ...
  "desktop.wsl.error.installOrchium": "No se pudo instalar Orchium",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.orchiumMissing": "orchium no está instalado en esta distribución",
  "desktop.wsl.error.orchiumCannotRun": "orchium está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Orchium finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.orchium.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.orchium.tagline": "Modelos optimizados y fiables",
  "dialog.provider.orchiumGo.tagline": "Suscripción económica para todos",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.orchiumZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Orchium.",
  ...
  "dialog.plugins.empty": "Plugins configurados en orchium.json",
  ...
  "dialog.server.description": "Cambiar el servidor de Orchium al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOrchium": "Comprobando Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Comprobando Orchium en {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Actualizando Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Actualizando Orchium en {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Actualiza Orchium en {{distro}}.",
  "wsl.onboarding.updateOrchium": "Actualizar Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium está listo en {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium está listo.",
  "wsl.onboarding.installOrchiumIn": "Instala Orchium en {{distro}}.",
  "wsl.onboarding.installOrchium": "Instalar Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Orchium pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Orchium no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Orchium ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Orchium",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (orchium.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Orchium aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Orchium dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Orchium",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Orchium en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Orchium sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Orchium.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Orchium",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Orchium.",
