...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Orchium įkelti nepavyko",
  "Orchium langas netikėtai užsidarė",
  "Orchium neatsako",
  ...
  "Orchium įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "orchium šiame distributyve neįdiegtas",
  "orchium įdiegtas, bet jo paleisti nepavyko",
  "Orchium neįdiegtas distributyve {{distro}}",
  "Orchium naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.orchium.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.orchium.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.orchiumGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.manage.context.label": "Konteksto ilgis",
  "dialog.model.manage.context.placeholder": "Konteksto ilgis",
  "dialog.model.manage.context.aria": "Konteksto ilgis {{model}}",
  "dialog.model.unpaid.freeModels.title": "Nemokami Orchium modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  "provider.connect.orchiumZen.line2":
    "Su vienu API raktu galėsite pasiekti tokius modelius kaip Claude, GPT, Gemini, GLM ir kt.",
  "provider.connect.orchiumZen.visit.prefix": "Aplankykite",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Orchium.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti orchium.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Orchium serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOrchium": "Tikrinama Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Tikrinama Orchium {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Atnaujinamas Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Atnaujinamas Orchium {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Atnaujinkite Orchium {{distro}}.",
  "wsl.onboarding.updateOrchium": "Atnaujinkite Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium yra paruoštas {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium yra paruoštas.",
  "wsl.onboarding.installOrchiumIn": "Įdiekite Orchium į {{distro}}.",
  "wsl.onboarding.installOrchium": "Įdiekite Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Orchium galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Orchium nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Orchium ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Orchium komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (orchium.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Orchium dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Orchium apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Orchium darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Orchium serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Orchium ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Orchium atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Orchium seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Orchium temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Orchium",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Orchium versiją.",
