export const dict = {
  ...
  "desktop.recovery.loadFailed": "Orchium መጫን አልቻለም",
  "desktop.recovery.terminated": "Orchium መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Orchium ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOrchium": "Orchiumመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.orchiumMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.orchiumCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Orchium ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.orchium.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.orchium.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.orchiumGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.manage.context.label": "የአውድ ርዝመት",
  "dialog.model.manage.context.placeholder": "የአውድ ርዝመት",
  "dialog.model.manage.context.aria": "የ{{model}} የአውድ ርዝመት",
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በOrchium",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በOrchium ይጠቀሙ።",
  ...
  "provider.connect.orchiumZen.line1": "Orchium ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.orchiumZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.orchiumZen.visit.prefix": "ጎብኝ ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በOrchium ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በOrchium ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ orchium.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Orchium አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOrchium": "መፈተሽ Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Orchiumን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOrchium": "በማዘመን ላይ Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "በማዘመን ላይ Orchium በ{{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "አዘምን Orchium በ{{distro}}።",
  "wsl.onboarding.updateOrchium": "አዘምን Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.orchiumReady": "Orchium ዝግጁ ነው።",
  "wsl.onboarding.installOrchiumIn": "መጫን Orchium በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOrchium": "ጫን Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchiumአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Orchium WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Orchium በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Orchium።",
  ...
  "help.tabs.introduction": "Orchium ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የOrchium ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለOrchium ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (orchium.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Orchium እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Orchium ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "Orchium ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የOrchium አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለOrchium",
  ...
  "settings.general.row.appearance.description": "Orchiumበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Orchium ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Orchium ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Orchium ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የOrchium እትም እያሄዱ ነው።",
