...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Orchium yüklenemedi",
  "desktop.recovery.terminated": "Orchium penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Orchium yanıt vermiyor",
  ...
  "desktop.wsl.error.installOrchium": "Orchium kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.orchiumMissing": "orchium bu dağıtımda kurulu değil",
  "desktop.wsl.error.orchiumCannotRun": "orchium kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Orchium güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.orchium.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.orchium.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.orchiumGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Orchium'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.orchiumZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Orchium'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Orchium'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler orchium.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Orchium sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOrchium": "Orchium kontrol ediliyor...",
  "wsl.onboarding.checkingOrchiumIn": "{{distro}} içinde Orchium kontrol ediliyor...",
  "wsl.onboarding.updatingOrchium": "Orchium güncelleniyor...",
  "wsl.onboarding.updatingOrchiumIn": "{{distro}} içinde Orchium güncelleniyor...",
  "wsl.onboarding.updateOrchiumIn": "{{distro}} içindeki Orchium'u güncelleyin.",
  "wsl.onboarding.updateOrchium": "Orchium'u güncelle",
  "wsl.onboarding.orchiumReadyIn": "{{distro}} içinde Orchium hazır.",
  "wsl.onboarding.orchiumReady": "Orchium hazır.",
  "wsl.onboarding.installOrchiumIn": "Orchium'u {{distro}} içine kurun.",
  "wsl.onboarding.installOrchium": "Orchium'u kur",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Orchium'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Orchium bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Orchium'u tekrar açın.",
  ...
  "help.tabs.introduction": "Orchium Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Orchium'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Orchium ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (orchium.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Orchium henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Orchium ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Orchium Masaüstü",
  ...
  "settings.desktop.wsl.description": "Orchium sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Orchium'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Orchium'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Orchium'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Orchium'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Orchium başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Orchium'un en son sürümünü kullanıyorsunuz.",
