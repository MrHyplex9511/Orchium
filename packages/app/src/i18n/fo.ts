export const dict = {
  ...
  "desktop.menu.documentation": "Orchium Skjøl",
  ...
  "desktop.menu.ariaLabel": "Orchium valmynd",
  ...
  "desktop.recovery.loadFailed": "Orchium miseydnaðist at heinta",
  "desktop.recovery.terminated": "Orchium vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "Orchium svarar ikki",
  ...
  "desktop.wsl.error.installOrchium": "Orchium uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.orchiumMissing": "orchium er ikki sett upp í hesi distro",
  "desktop.wsl.error.orchiumCannotRun": "orchium er sett upp men kundi ikki koyra",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Orchium dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.provider.orchium.note": "Kuraterað modell íroknað Claude, GPT, Gemini og fleiri",
  "dialog.provider.orchium.tagline": "Álítandi optimerað modell",
  "dialog.provider.orchiumGo.tagline": "Lágkostnaðarhald fyri øll",
  ...
  "dialog.model.manage.context.label": "Samanhagslongd",
  "dialog.model.manage.context.placeholder": "Samanhagslongd",
  "dialog.model.manage.context.aria": "Samanhagslongd fyri {{model}}",
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av Orchium",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen gevur tær atgongd til eitt kuraterað sett av álítandi optimeraðum modellum til kodingaragentar.",
  "provider.connect.orchiumZen.line2":
    "Við einum API lykli fært tú atgongd til modellir sum Claude, GPT, Gemini, GLM og fleiri.",
  "provider.connect.orchiumZen.visit.prefix": "Vitja ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " fyri at savna tín API lykil.",
  "provider.connect.oauth.code.visit.prefix": "Vitja ",
  "provider.connect.oauth.code.visit.link": "hesa leinkjuna",
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í Orchium.",
  ...
  "dialog.plugins.empty": "Tilskot uppsett í orchium.json",
  ...
  "dialog.server.description": "Skift hvønn Orchium ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOrchium": "Kanna Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Kanna Orchium í {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Dagføring Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Dagføring Orchium í {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Dagfør Orchium í {{distro}}.",
  "wsl.onboarding.updateOrchium": "Dagfør Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium er klárt í {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium er klárt.",
  "wsl.onboarding.installOrchiumIn": "Set Orchium upp í {{distro}}.",
  "wsl.onboarding.installOrchium": "Set upp Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn Orchium kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "Orchium kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani Orchium aftur.",
  ...
  "help.tabs.introduction": "Orchium Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av Orchium ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til Orchium toymið",
  ...
  "error.chain.checkConfig": "Kanna tíni uppseting (orchium.json) veitara/modell nøvn",
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, Orchium stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "Orchium inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "Orchium Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr Orchium ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri Orchium",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu Orchium sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um Orchium fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu Orchium er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá Orchium byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av Orchium.",
