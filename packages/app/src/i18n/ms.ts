export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Orchium",
  ...
  "desktop.recovery.loadFailed": "Orchium gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Orchium ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Orchium tidak memberi respons",
  ...
  "desktop.wsl.error.installOrchium": "Pemasangan Orchium gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.orchiumMissing": "orchium tidak dipasang dalam distro ini",
  "desktop.wsl.error.orchiumCannotRun": "orchium dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Orchium selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.orchium.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.orchium.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.orchiumGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Orchium",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Layari",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Orchium.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam orchium.json",
  ...
  "dialog.server.description": "Tukar pelayan Orchium yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOrchium": "Sedang menyemak Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Sedang menyemak Orchium dalam {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Sedang mengemas kini Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Sedang mengemas kini Orchium dalam {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Kemas kini Orchium dalam {{distro}}.",
  "wsl.onboarding.updateOrchium": "Kemas kini Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium sedia digunakan.",
  "wsl.onboarding.installOrchiumIn": "Pasang Orchium dalam {{distro}}.",
  "wsl.onboarding.installOrchium": "Pasang Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Orchium boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Orchium tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Orchium ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Orchium",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (orchium.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Orchium belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Orchium dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Orchium",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Orchium pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Orchium mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Orchium.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Orchium dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Orchium.",
