...
export const dict = {
  ...
  "desktop.menu.documentation": "Orchium-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Orchium-meny",
  ...
  "desktop.recovery.loadFailed": "Orchium kunne ikke lastes inn",
  "desktop.recovery.terminated": "Orchium-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Orchium svarer ikke",
  ...
  "desktop.wsl.error.installOrchium": "Installasjonen av Orchium mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.orchiumMissing": "orchium er ikke installert i denne distribusjonen",
  "desktop.wsl.error.orchiumCannotRun": "orchium er installert, men kunne ikke kjøres",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Orchium er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.orchium.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.orchium.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.orchiumGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.manage.context.label": "Kontekstlengde",
  "dialog.model.manage.context.placeholder": "Kontekstlengde",
  "dialog.model.manage.context.aria": "Kontekstlengde for {{model}}",

  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Orchium",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.orchiumZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.orchiumZen.visit.prefix": "Besøk ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Orchium.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i orchium.json",
  ...
  "dialog.server.description": "Bytt hvilken Orchium-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Orchium ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Orchium-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (orchium.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Orchium ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Orchium inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Orchium-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Orchium",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Orchium ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Orchium skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Orchium.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Orchium starter",
  ...
  "settings.updates.toast.latest.title": "Orchium er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Orchium.",
  ...
  "wsl.onboarding.checkingOrchium": "Sjekker Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Sjekker Orchium i {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Oppdaterer Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Oppdaterer Orchium i {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Oppdater Orchium i {{distro}}.",
  "wsl.onboarding.updateOrchium": "Oppdater Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium er klar i {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium er klar.",
  "wsl.onboarding.installOrchiumIn": "Installer Orchium i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Orchium kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Orchium kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Orchium på nytt.",
  ...
  "help.tabs.introduction": "Orchium Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
