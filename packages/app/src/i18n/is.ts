...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða Orchium",
  "Orchium-glugganum var óvænt lokað",
  "Orchium svarar ekki",
  ...
  "Uppsetning Orchium mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "orchium er ekki uppsett í þessari dreifingu",
  "orchium er uppsett en ekki var hægt að keyra það",
  "Orchium er ekki uppsett í {{distro}}",
  "Uppfærslu Orchium lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.orchium.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.orchium.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.orchiumGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.manage.context.label": "Samhengislengd",
  "dialog.model.manage.context.placeholder": "Samhengislengd",
  "dialog.model.manage.context.aria": "Samhengislengd fyrir {{model}}",
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá Orchium",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.orchiumZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.orchiumZen.visit.prefix": "Heimsókn",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í Orchium.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í orchium.json",
  ...
  "dialog.server.description": "Skiptu um hvaða Orchium miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOrchium": "Athugar Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Athugar Orchium í {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Uppfærir Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Uppfærir Orchium í {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Uppfærðu Orchium í {{distro}}.",
  "wsl.onboarding.updateOrchium": "Uppfærðu Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium er tilbúið í {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium er tilbúinn.",
  "wsl.onboarding.installOrchiumIn": "Settu upp Orchium í {{distro}}.",
  "wsl.onboarding.installOrchium": "Settu upp Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en Orchium getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "Orchium gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan Orchium aftur.",
  ...
  "help.tabs.introduction": "Orchium Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af Orchium ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til Orchium teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (orchium.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, Orchium styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "Orchium inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "Orchium skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu Orchium netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir Orchium",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig Orchium lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort Orchium fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig Orchium er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar Orchium ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af Orchium.",
