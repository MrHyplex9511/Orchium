export const dict = {
  ...
  "desktop.recovery.loadFailed": "Orchium laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Orchium aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Orchium ei vasta",
  ...
  "desktop.wsl.error.installOrchium": "Orchium installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.orchiumMissing": "orchium pole sellesse distrosse installitud",
  "desktop.wsl.error.orchiumCannotRun": "orchium on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Orchium värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.orchium.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.orchium.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.orchiumGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.manage.context.label": "Konteksti pikkus",
  "dialog.model.manage.context.placeholder": "Konteksti pikkus",
  "dialog.model.manage.context.aria": "Konteksti pikkus mudelil {{model}}",
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Orchium",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Orchium'is.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Külastage ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Orchium.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis orchium.json",
  ...
  "dialog.server.description": "Lülitage, millise Orchium serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOrchium": "Orchium kontrollimine...",
  "wsl.onboarding.checkingOrchiumIn": "Orchium kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Orchium värskendamine...",
  "wsl.onboarding.updatingOrchiumIn": "Orchium värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Värskenda Orchium jaotises {{distro}}.",
  "wsl.onboarding.updateOrchium": "Värskenda Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium on valmis {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium on valmis.",
  "wsl.onboarding.installOrchiumIn": "Installige Orchium asukohta {{distro}}.",
  "wsl.onboarding.installOrchium": "Installige Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Orchium saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Orchium ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Orchium.",
  ...
  "help.tabs.introduction": "Orchium Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Orchium ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Orchium meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (orchium.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Orchium ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Orchium sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Orchium Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Orchium server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Orchium kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Orchium teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Orchium järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Orchium on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Orchium käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Orchium uusimat versiooni.",
