export const dict = {
  ...
  "dialog.provider.orchium.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.orchium.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.orchiumGo.tagline": "Billigt abonnement for alle",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.orchiumZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.orchiumZen.visit.prefix": "Besøg ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Orchium.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i orchium.json",
  ...
  "dialog.server.description": "Skift hvilken Orchium-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOrchium": "Tjekker Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Tjekker Orchium i {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Opdaterer Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Opdaterer Orchium i {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Opdater Orchium i {{distro}}.",
  "wsl.onboarding.updateOrchium": "Opdater Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Orchium kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Orchium kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Orchium igen.",
  ...
  "toast.update.description": "En ny version af Orchium ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Orchium-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (orchium.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Orchium understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Orchium inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Orchium-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Orchium",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Orchium ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Orchium skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Orchiums tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Orchium starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Orchium.",
  ...
  "desktop.recovery.loadFailed": "Orchium kunne ikke indlæses",
  "desktop.recovery.terminated": "Orchium-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOrchium": "Installationen af Orchium mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.orchiumMissing": "orchium er ikke installeret i denne distribution",
  "desktop.wsl.error.orchiumCannotRun": "orchium er installeret, men kunne ikke køre",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Orchium er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Orchium Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
