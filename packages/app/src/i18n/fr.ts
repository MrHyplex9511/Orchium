export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Orchium",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Orchium",
  "desktop.recovery.terminated": "La fenêtre Orchium s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Orchium ne répond pas",
  ...
  "desktop.wsl.error.installOrchium": "Échec de l'installation d'Orchium",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.orchiumMissing": "orchium n'est pas installé dans cette distribution",
  "desktop.wsl.error.orchiumCannotRun": "orchium est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Orchium est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.orchium.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.orchium.tagline": "Modèles optimisés et fiables",
  "dialog.provider.orchiumGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.manage.context.label": "Longueur du contexte",
  "dialog.model.manage.context.placeholder": "Longueur du contexte",
  "dialog.model.manage.context.aria": "Longueur du contexte pour {{model}}",
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Orchium",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Visitez ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Orchium.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans orchium.json",
  ...
  "dialog.server.description": "Changez le serveur Orchium auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOrchium": "Vérification d'Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Vérification d'Orchium dans {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Mise à jour d'Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Mise à jour d'Orchium dans {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Mettez à jour Orchium dans {{distro}}.",
  "wsl.onboarding.updateOrchium": "Mettre à jour Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium est prêt dans {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium est prêt.",
  "wsl.onboarding.installOrchiumIn": "Installez Orchium dans {{distro}}.",
  "wsl.onboarding.installOrchium": "Installer Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Orchium puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Orchium n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Orchium ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Orchium",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (orchium.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Orchium ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Orchium inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Orchium dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Orchium",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Orchium sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Orchium suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Orchium.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Orchium",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Orchium.",
