export const dict = {
  ...
  "desktop.menu.documentation": "Orchium hujjatlari",
  ...
  "desktop.menu.ariaLabel": "Orchium menyusi",
  ...
  "desktop.recovery.loadFailed": "Orchium yuklanmadi",
  "desktop.recovery.terminated": "Orchium oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "Orchium javob bermayapti",
  ...
  "desktop.wsl.error.installOrchium": "Orchium oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.orchiumMissing": "Orchium ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.orchiumCannotRun": "orchium o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "Orchium yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.orchium.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.orchium.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.orchiumGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.manage.context.label": "Kontekst uzunligi",
  "dialog.model.manage.context.placeholder": "Kontekst uzunligi",
  "dialog.model.manage.context.aria": "{{model}} uchun kontekst uzunligi",
  "dialog.model.unpaid.freeModels.title": "Orchium tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va Orchium’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va Orchium da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va Orchium da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "orchium.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi Orchium serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOrchium": "Orchium tekshirilmoqda...",
  "wsl.onboarding.checkingOrchiumIn": "Orchium {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOrchium": "Orchium yangilanmoqda...",
  "wsl.onboarding.updatingOrchiumIn": "Orchium {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOrchiumIn": "Orchium-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOrchium": "Orchium-ni yangilang",
  "wsl.onboarding.orchiumReadyIn": "Orchium {{distro}} da tayyor.",
  "wsl.onboarding.orchiumReady": "Orchium tayyor.",
  "wsl.onboarding.installOrchiumIn": "Orchium-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOrchium": "Orchium-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Orchium WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "Orchium WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra Orchium-ni qayta oching.",
  ...
  "help.tabs.introduction": "Orchium Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Orchium ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida Orchium jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (orchium.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, Orchium hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "Orchium bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi Orchium serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "Orchium uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "Orchium qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "Orchium tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "Orchium mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "Orchium ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz Orchium oxirgi versiyasini ishga tushiryapsiz.",
