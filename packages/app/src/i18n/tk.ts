export const dict = {
  ...
  "desktop.menu.documentation": "Orchium Resminamalar",
  ...
  "desktop.menu.ariaLabel": "Orchium menýusy",
  ...
  "desktop.recovery.loadFailed": "Orchium ýükläp bilmedi",
  "desktop.recovery.terminated": "Orchium penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "Orchium jogap berenok",
  ...
  "desktop.wsl.error.installOrchium": "Orchium gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.orchiumMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.orchiumCannotRun": "orchium guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "Orchium täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.orchium.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.orchium.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.orchiumGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.manage.context.label": "Kontekstiň uzynlygy",
  "dialog.model.manage.context.placeholder": "Kontekstiň uzynlygy",
  "dialog.model.manage.context.aria": "{{model}} üçin kontekstiň uzynlygy",
  "dialog.model.unpaid.freeModels.title": "Orchium tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we Orchium-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Sapar ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Orchium-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini Orchium-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "orchium.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy Orchium serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOrchium": "Orchium barlamak ...",
  "wsl.onboarding.checkingOrchiumIn": "{{distro}} içinde Orchium barlanýar...",
  "wsl.onboarding.updatingOrchium": "Orchium täzelenmek ...",
  "wsl.onboarding.updatingOrchiumIn": "{{distro}}-de Orchium täzelenmek ...",
  "wsl.onboarding.updateOrchiumIn": "Orchium-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOrchium": "Orchium täzeläň",
  "wsl.onboarding.orchiumReadyIn": "Orchium {{distro}}-de taýýar.",
  "wsl.onboarding.orchiumReady": "Orchium taýýar.",
  "wsl.onboarding.installOrchiumIn": "{{distro}}-de Orchium guruň.",
  "wsl.onboarding.installOrchium": "Orchium guruň",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) Orchium WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "Orchium bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra Orchium açyň.",
  ...
  "help.tabs.introduction": "Orchium Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin Orchium ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy Orchium toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (orchium.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, Orchium entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "Orchium mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "Orchium serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "Orchium üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "Orchium enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "Orchium ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "Orchium-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "Orchium işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "Orchium-iň iň soňky wersiýasyny işleýärsiňiz.",
