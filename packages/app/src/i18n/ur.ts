export const dict = {
  ...
  "desktop.menu.documentation": "Orchium دستاویزات",
  ...
  "desktop.menu.ariaLabel": "Orchium مینو",
  ...
  "desktop.recovery.loadFailed": "Orchium لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "Orchium ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "Orchium جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOrchium": "Orchium کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.orchiumMissing": "اس ڈسٹری بیوشن میں orchium انسٹال نہیں ہے",
  "desktop.wsl.error.orchiumCannotRun": "orchium انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.orchiumNotInstalled": "{{distro}} میں Orchium انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "Orchium کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.provider.orchium.note": "کیوریٹ شدہ ماڈلز بشمول Claude، GPT، Gemini اور مزید",
  "dialog.provider.orchium.tagline": "قابل اعتماد آپٹمائزڈ ماڈلز",
  "dialog.provider.orchiumGo.tagline": "سب کے لیے کم لاگت کی رکنیت",
  ...
  "dialog.model.manage.context.label": "سیاق و سباق کی لمبائی",
  "dialog.model.manage.context.placeholder": "سیاق و سباق کی لمبائی",
  "dialog.model.manage.context.aria": "{{model}} کے لیے سیاق و سباق کی لمبائی",
  "dialog.model.unpaid.freeModels.title": "Orchium کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور Orchium میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen آپ کو کوڈنگ ایجنٹوں کے لیے قابل اعتماد اصلاح شدہ ماڈلز کے کیوریٹڈ سیٹ تک رسائی فراہم کرتا ہے۔",
  "provider.connect.orchiumZen.line2":
    "ایک واحد API کلید کے ساتھ آپ Claude، GPT، Gemini، GLM اور مزید ماڈلز تک رسائی حاصل کریں گے۔",
  "provider.connect.orchiumZen.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " اور اپنی API کلید حاصل کریں۔",
  "provider.connect.oauth.code.visit.prefix": "ملاحظہ کریں ",
  "provider.connect.oauth.code.visit.link": "یہ لنک",
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور Orchium میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور Orchium میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.plugins.empty": "orchium.json میں کنفیگر کردہ پلگ انز",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس Orchium سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOrchium": "Orchium چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOrchiumIn": "{{distro}} میں Orchium چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOrchium": "Orchium کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOrchiumIn": "{{distro}} میں Orchium کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOrchiumIn": "{{distro}} میں Orchium کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOrchium": "Orchium کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.orchiumReadyIn": "Orchium {{distro}} میں تیار ہے۔",
  "wsl.onboarding.orchiumReady": "Orchium تیار ہے۔",
  "wsl.onboarding.installOrchiumIn": "{{distro}} میں Orchium انسٹال کریں۔",
  "wsl.onboarding.installOrchium": "Orchium انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ Orchium WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "Orchium اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر Orchium کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "Orchium Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Orchium ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم Orchium ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.checkConfig": "اپنی تشکیل (orchium.json) فراہم کنندہ/ماڈل کے نام چیک کریں۔",
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، Orchium ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "Orchium میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "Orchium ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر Orchium سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "Orchium کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر Orchium کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا Orchium سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "Orchium کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "Orchium لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ Orchium کا تازہ ترین ورژن چلا رہے ہیں۔",
