export const dict = {
  ...
  "desktop.menu.documentation": "Orchium Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka Orchium",
  ...
  "desktop.recovery.loadFailed": "Orchium se nepodařilo načíst",
  "desktop.recovery.terminated": "Orchium okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "Orchium nereaguje",
  ...
  "desktop.wsl.error.installOrchium": "Orchium instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.orchiumMissing": "orchium není v této distribuci nainstalováno",
  "desktop.wsl.error.orchiumCannotRun": "orchium je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Orchium aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.orchium.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.orchium.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.orchiumGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "dialog.model.manage.context.label": "Délka kontextu",
  "dialog.model.manage.context.placeholder": "Délka kontextu",
  "dialog.model.manage.context.aria": "Délka kontextu pro {{model}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Návštěva ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v Orchium.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v orchium.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému Orchium serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOrchium": "Kontrola Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Kontrola Orchium v {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Aktualizace Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Aktualizace Orchium v {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Aktualizace Orchium v {{distro}}.",
  "wsl.onboarding.updateOrchium": "Aktualizovat Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium je připraveno v {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium je připraven.",
  "wsl.onboarding.installOrchiumIn": "Nainstalujte Orchium do {{distro}}.",
  "wsl.onboarding.installOrchium": "Instalovat Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než Orchium může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "Orchium nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete Orchium.",
  ...
  "help.tabs.introduction": "Orchium Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze Orchium ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu Orchium",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (orchium.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: Orchium zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server Orchium uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro Orchium",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled Orchium na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude Orchium následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma Orchium.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění Orchium",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi Orchium.",
