export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Orchium",
  ...
  "desktop.recovery.loadFailed": "Orchium se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Orchium-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Orchium ne reaguje",
  ...
  "desktop.wsl.error.installOrchium": "Instalacija Orchium-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.orchiumMissing": "orchium nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.orchiumCannotRun": "orchium je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Orchium-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.orchium.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.orchium.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.orchiumGo.tagline": "Povoljna pretplata za sve",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Orchium-u.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.orchiumZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.orchiumZen.visit.prefix": "Posjeti ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Orchium-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Orchium-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u orchium.json",
  ...
  "dialog.server.description": "Promijeni na koji se Orchium server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOrchium": "Provjera Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Provjera Orchium u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Ažuriranje Orchium...",
  "wsl.onboarding.updatingOrchiumIn": "Ažuriranje Orchium u distribuciji {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Ažuriraj Orchium u distribuciji {{distro}}.",
  "wsl.onboarding.updateOrchium": "Ažuriraj Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium je spreman.",
  "wsl.onboarding.installOrchiumIn": "Instaliraj Orchium u distribuciji {{distro}}.",
  "wsl.onboarding.installOrchium": "Instaliraj Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Orchium mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Orchium nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Orchium-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Orchium timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (orchium.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Orchium još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Orchium uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Orchium server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Orchium-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Orchium izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Orchium prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Orchium-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Orchium pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Orchium-a.",
