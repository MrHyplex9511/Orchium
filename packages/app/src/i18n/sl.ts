export const dict = {
  ...
  "desktop.menu.documentation": "Orchium Dokumentacija",
  ...
  "desktop.menu.ariaLabel": "Orchium meni",
  ...
  "desktop.recovery.loadFailed": "Orchium ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno Orchium se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "Orchium se ne odziva",
  ...
  "desktop.wsl.error.installOrchium": "Namestitev Orchium ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.orchiumMissing": "orchium ni nameščen v tej distribuciji",
  "desktop.wsl.error.orchiumCannotRun": "orchium je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev Orchium je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.orchium.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.orchium.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.orchiumGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.manage.context.label": "Dolžina konteksta",
  "dialog.model.manage.context.placeholder": "Dolžina konteksta",
  "dialog.model.manage.context.aria": "Dolžina konteksta za {{model}}",
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja Orchium",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Obisk ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v Orchium.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v orchium.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom Orchium se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOrchium": "Preverjanje Orchium ...",
  "wsl.onboarding.checkingOrchiumIn": "Preverjanje Orchium v {{distro}} ...",
  "wsl.onboarding.updatingOrchium": "Posodabljanje Orchium ...",
  "wsl.onboarding.updatingOrchiumIn": "Posodabljanje Orchium v {{distro}} ...",
  "wsl.onboarding.updateOrchiumIn": "Posodobite Orchium v {{distro}}.",
  "wsl.onboarding.updateOrchium": "Posodobite Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium je pripravljen v {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium je pripravljen.",
  "wsl.onboarding.installOrchiumIn": "Namestite Orchium v {{distro}}.",
  "wsl.onboarding.installOrchium": "Namestite Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko Orchium doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "Orchium ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica Orchium ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi Orchium",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (orchium.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, Orchium še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik Orchium znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za Orchium",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako Orchium izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali Orchium sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo Orchium.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene Orchium",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico Orchium.",
