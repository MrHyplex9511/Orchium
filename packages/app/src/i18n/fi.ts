export const dict = {
  ...
  "dialog.provider.orchium.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.orchium.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.orchiumGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.manage.context.label": "Kontekstin pituus",
  "dialog.model.manage.context.placeholder": "Kontekstin pituus",
  "dialog.model.manage.context.aria": "Kontekstin pituus mallille {{model}}",
  "dialog.model.unpaid.freeModels.title": "Orchiumn tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Orchiumssa.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Avaa ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Orchiumssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Orchiumssa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään orchium.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda Orchium-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOrchium": "Tarkistetaan Orchiuma...",
  "wsl.onboarding.checkingOrchiumIn": "Tarkistetaan Orchiuma kohteessa {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Päivitetään Orchiuma...",
  "wsl.onboarding.updatingOrchiumIn": "Päivitetään Orchiuma kohteessa {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Päivitä Orchium jakelussa {{distro}}.",
  "wsl.onboarding.updateOrchium": "Päivitä Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium on valmis jakelussa {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium on valmis.",
  "wsl.onboarding.installOrchiumIn": "Asenna Orchium jakeluun {{distro}}.",
  "wsl.onboarding.installOrchium": "Asenna Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchiuma ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Orchium voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Orchium ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Orchium uudelleen.",
  ...
  "toast.update.description": "Orchiumn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Orchium-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (orchium.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Orchium ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Orchium sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Orchium-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Orchiumn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Orchium näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Orchium järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Orchiumn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Orchium käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Orchiumn uusinta versiota.",
  ...
  "desktop.menu.documentation": "Orchium-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Orchium-valikko",
  ...
  "desktop.recovery.loadFailed": "Orchiumn lataaminen epäonnistui",
  "desktop.recovery.terminated": "Orchium-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Orchium ei vastaa",
  ...
  "desktop.wsl.error.installOrchium": "Orchiumn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.orchiumMissing": "orchiuma ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.orchiumCannotRun": "orchium on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.orchiumNotInstalled": "Orchiuma ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Orchiumn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Orchium Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
