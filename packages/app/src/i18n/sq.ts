export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni Orchium",
  ...
  "desktop.menu.ariaLabel": "Menuja Orchium",
  ...
  "desktop.recovery.loadFailed": "Orchium nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja Orchium u mbyll papritur",
  "desktop.recovery.unresponsive": "Orchium nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOrchium": "Instalimi i Orchium dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.orchiumMissing": "Orchium nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.orchiumCannotRun": "Orchium është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.orchiumNotInstalled": "Orchium nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i Orchium përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.orchium.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.orchium.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.orchiumGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.manage.context.label": "Gjatësia e kontekstit",
  "dialog.model.manage.context.placeholder": "Gjatësia e kontekstit",
  "dialog.model.manage.context.aria": "Gjatësia e kontekstit për {{model}}",
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga Orchium",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në Orchium.",
  ...
  "provider.connect.orchiumZen.line1":
    "Orchium Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.orchiumZen.visit.prefix": "Vizitoni ",
  "provider.connect.orchiumZen.visit.link": "opencode.ai/zen",
  "provider.connect.orchiumZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Orchium.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në Orchium.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në orchium.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server Orchium lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOrchium": "Po kontrollon Orchium...",
  "wsl.onboarding.checkingOrchiumIn": "Po kontrollon Orchium në {{distro}}...",
  "wsl.onboarding.updatingOrchium": "Orchium po përditësohet...",
  "wsl.onboarding.updatingOrchiumIn": "Po përditëson Orchium në {{distro}}...",
  "wsl.onboarding.updateOrchiumIn": "Përditëso Orchium në {{distro}}.",
  "wsl.onboarding.updateOrchium": "Përditëso Orchium",
  "wsl.onboarding.orchiumReadyIn": "Orchium është gati në {{distro}}.",
  "wsl.onboarding.orchiumReady": "Orchium është gati.",
  "wsl.onboarding.installOrchiumIn": "Instaloni Orchium në {{distro}}.",
  "wsl.onboarding.installOrchium": "Instaloni Orchium",
  ...
  "wsl.onboarding.distroStatus.orchiumMissing": "Orchium nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se Orchium të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "Orchium nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap Orchium.",
  ...
  "help.tabs.introduction": "Orchium Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i Orchium ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i Orchium",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (orchium.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, Orchium nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "Orchium përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin Orchium brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për Orchium",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket Orchium në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse Orchium ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e Orchium.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset Orchium",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të Orchium.",
