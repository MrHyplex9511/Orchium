...
const GLOBAL_STORAGE = "orchium.global.dat"
const WINDOW_STORAGE = "orchium.window"
const LOCAL_PREFIX = "orchium."
...
function workspaceStorage(dir: string) {
  ...
  return `orchium.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `orchium.draft.${head}.${sum}.dat`
}
