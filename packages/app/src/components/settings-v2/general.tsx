...
import { Switch } from "@orchium/ui/v2/switch-v2"
        ...
        <SettingsRowV2
          ...
          description={
            <>
              ...
              <ExternalLink class="settings-v2-link" href="https://github.com/MrHyplex9511/Orchium">
  ...
  const GeneralSection = () => (
    <div class="settings-v2-section">
      <SettingsListV2>
        ...
        <Show when={mobile() && import.meta.env.VITE_ORCHIUM_CHANNEL !== "prod"}>
          <SettingsRowV2
