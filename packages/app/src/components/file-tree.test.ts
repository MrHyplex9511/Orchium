...
beforeAll(async () => {
  ...
  mock.module("@orchium/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@orchium/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@orchium/ui/icon", () => ({ Icon: () => null }))
  mock.module("@orchium/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
