import type { SessionApi } from "@orchium/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { OrchiumClient } from "@orchium/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: OrchiumClient; directory: string; limit: number }) {
  try {
