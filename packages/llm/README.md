...
Schema-first LLM core for orchium. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@orchium/llm"
import { OpenAI } from "@orchium/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@orchium/llm/providers"
