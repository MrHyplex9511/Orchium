...
declare const ORCHIUM_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof ORCHIUM_CLI_NAME === "string" ? ORCHIUM_CLI_NAME : "orchium", {
  description: "Orchium 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
