...
Practical reference for the current tool-migration state in `packages/orchium`.
...
Tool tests should use the existing Effect helpers in `packages/orchium/test/lib/effect.ts`:
