...
export class Service extends Context.Service<Service, Interface>()("@orchium/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __ORCHIUM_PHOTON_WASM_PATH?: string }).__ORCHIUM_PHOTON_WASM_PATH =
