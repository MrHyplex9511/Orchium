...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@orchium/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/ToolRegistry") {}
