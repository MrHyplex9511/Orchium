import type { Hooks, PluginInput } from "@orchium/plugin"
import type { Model } from "@orchium/sdk/v2"
import { InstallationVersion } from "@orchium/core/installation/version"
import { OauthCallbackPage } from "@orchium/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Orchium will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
