...
import { WorkspaceEvent } from "@orchium/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        ORCHIUM_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        ORCHIUM_WORKSPACE_ID: config.id,
        ORCHIUM_EXPERIMENTAL_WORKSPACES: "true",
