...
import { makeApi } from "@orchium/protocol/api"
import { LocationMiddleware } from "@orchium/server/location"
import { SessionLocationMiddleware } from "@orchium/server/middleware/session-location"
...
export const RootHttpApi = HttpApi.make("orchium-root")
...
export const InstanceHttpApi = HttpApi.make("orchium-instance")
...
export const OrchiumHttpApi = HttpApi.make("orchium")
