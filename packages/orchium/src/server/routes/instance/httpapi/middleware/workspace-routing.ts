...
>()("@orchium/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@orchium/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.ORCHIUM_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.ORCHIUM_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-orchium-directory"] || process.cwd()
}
