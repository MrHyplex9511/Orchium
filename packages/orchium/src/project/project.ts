...
import { ProjectDirectoryTable, ProjectTable } from "@orchium/core/project/sql"
import { ProjectDirectories } from "@orchium/core/project/directories"
...
import { which } from "@orchium/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.ORCHIUM_FAKE_VCS)
