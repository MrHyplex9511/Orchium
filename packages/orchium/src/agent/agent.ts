...
import { AbsolutePath, type DeepMutable } from "@orchium/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".orchium", "plans", "*.md")]: "allow",
