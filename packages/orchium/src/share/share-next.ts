...
import type * as SDK from "@orchium/sdk/v2"
...
import { SessionShareTable } from "@orchium/core/share/sql"
import { ProviderV2 } from "@orchium/core/provider"
import { ModelV2 } from "@orchium/core/model"
import { EventV2 } from "@orchium/core/event"

const disabled = process.env["ORCHIUM_DISABLE_SHARE"] === "true" || process.env["ORCHIUM_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/ShareNext") {}
