...
import { openEditor } from "@orchium/tui/editor"
import { registerOrchiumKeymap } from "@orchium/tui/keymap"
...
export async function createRuntimeLifecycle(input: LifecycleInput): Promise<Lifecycle> {
  ...
  try {
    ...
    unregisterKeymap = registerOrchiumKeymap(keymap, renderer, input.tuiConfig)
