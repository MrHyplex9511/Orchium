...
//
// The saved variant persists across sessions in ~/.local/state/orchium/model.json
...
class Service extends Context.Service<Service, VariantService>()("@orchium/RunVariant") {}
