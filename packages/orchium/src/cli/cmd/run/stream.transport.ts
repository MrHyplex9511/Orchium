...
import type { Event, GlobalEvent, OrchiumClient } from "@orchium/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@orchium/RunStreamTransport") {}
