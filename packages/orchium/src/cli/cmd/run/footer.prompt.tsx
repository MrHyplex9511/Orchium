...
import { normalizePromptContent } from "@orchium/tui/editor"
...
import { ORCHIUM_BASE_MODE, useBindings } from "@orchium/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Orchium" } satisfies SlashOption,
    ]
