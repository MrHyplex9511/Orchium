 ...
 *   "@orchium/ServerAuthConfig",
 *   {
 *     password: Config.string("ORCHIUM_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("ORCHIUM_SERVER_USERNAME").pipe(Config.withDefault("orchium")),
 *   },
 * ) {}
 *
