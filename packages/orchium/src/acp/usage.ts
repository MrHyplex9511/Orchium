...
import type { AssistantMessage as OrchiumAssistantMessage, Message } from "@orchium/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@orchium/core/effect/app-node"
...
export type AssistantTokenCost = Pick<OrchiumAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<OrchiumAssistantMessage, "role"> &
  Partial<Pick<OrchiumAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@orchium/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@orchium/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@orchium/ACPUsage") {}
