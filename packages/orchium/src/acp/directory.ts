...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@orchium/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@orchium/ACPDirectory") {}
