...
import { buildPrompt } from "@orchium/core/session/compaction"
import { SessionCompactionEvent } from "@orchium/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/SessionCompaction") {}
