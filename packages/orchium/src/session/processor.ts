...
import { Usage, type LLMEvent } from "@orchium/llm"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/SessionProcessor") {}
      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "step-finish": {
            ...
            // prompt. Prefix mismatches mean orchium changed history behind a signed
