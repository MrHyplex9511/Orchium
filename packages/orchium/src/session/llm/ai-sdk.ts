import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@orchium/llm"
...
// Move this extraction into @orchium/llm when Copilot is handled by the native runtime.
