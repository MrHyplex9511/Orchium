import type { JsonSchema, LLMRequest, ProviderMetadata } from "@orchium/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@orchium/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @orchium/llm request objects from orchium's session/AI SDK-shaped data.
  return LLM.request({
