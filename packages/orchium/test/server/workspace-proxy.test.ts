...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips orchium-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-orchium-directory"]).toBeUndefined()
      expect(forwarded["x-orchium-workspace"]).toBeUndefined()
