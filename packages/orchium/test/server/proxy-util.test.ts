...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips orchium-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-orchium-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-orchium-directory")).toBeNull()
      expect(result.get("x-orchium-workspace")).toBeNull()
