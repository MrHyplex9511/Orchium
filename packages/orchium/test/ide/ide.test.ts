...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ORCHIUM_CALLER", () => {
    process.env["ORCHIUM_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ORCHIUM_CALLER", () => {
    process.env["ORCHIUM_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ORCHIUM_CALLER", () => {
    process.env["ORCHIUM_CALLER"] = "unknown"
