...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/orchium.git")).toEqual({ owner: "sst", repo: "orchium" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/orchium")).toEqual({ owner: "sst", repo: "orchium" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/orchium.git")).toEqual({ owner: "sst", repo: "orchium" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/orchium")).toEqual({ owner: "sst", repo: "orchium" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/orchium.git")).toEqual({ owner: "sst", repo: "orchium" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/orchium")).toEqual({ owner: "sst", repo: "orchium" })
})
