        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g orchium")}>
                <code>
                  npm i -g <strong>orchium</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g orchium")}>
                <code>
                  bun add -g <strong>orchium</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/orchium")}>
                <code>
                  brew install <strong>anomalyco/tap/orchium</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S orchium")}>
                <code>
                  paru -S <strong>orchium</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask orchium-desktop")}>
                <code>
                  brew install --cask <strong>orchium-desktop</strong>
                </code>
                <CopyStatus />
              </button>
