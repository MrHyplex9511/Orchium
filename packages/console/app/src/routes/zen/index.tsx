...
import compareVideo from "../../asset/lander/orchium-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/orchium-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="orchium:auth" content={loggedin() ? "true" : "false"} />
