...
import { and, Database, eq, isNull } from "@orchium/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@orchium/console-core/schema/billing.sql.js"
    ...
    return new Response(
      JSON.stringify({
        ...
        error: {
          ...
          message: "Orchium Go subscription required.",
        },
      }),
      {
        status: 403,
