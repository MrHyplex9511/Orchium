...
import { and, Database, eq, isNull, lt, or, sql } from "@orchium/console-core/drizzle/index.js"
import { KeyTable } from "@orchium/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@orchium/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@orchium/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@orchium/console-core/util/date.js"
import { Identifier } from "@orchium/console-core/identifier.js"
import { Billing } from "@orchium/console-core/billing.js"
import { Actor } from "@orchium/console-core/actor.js"
import { WorkspaceTable } from "@orchium/console-core/schema/workspace.sql.js"
import { ZenData } from "@orchium/console-core/model.js"
import { Subscription } from "@orchium/console-core/subscription.js"
import { BlackData } from "@orchium/console-core/black.js"
import { UserTable } from "@orchium/console-core/schema/user.sql.js"
import { ModelTable } from "@orchium/console-core/schema/model.sql.js"
import { ProviderTable } from "@orchium/console-core/schema/provider.sql.js"
...
import { LiteData } from "@orchium/console-core/lite.js"
import { Resource } from "@orchium/console-resource"
...
import { Workspace } from "@orchium/console-core/workspace.js"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-orchium-session") ?? ""
    const requestId = input.request.headers.get("x-orchium-request") ?? ""
    const ocClient = input.request.headers.get("x-orchium-client") ?? ""
    const projectId = input.request.headers.get("x-orchium-project") ?? ""
    ...
    const providerRequest = async () => {
      ...
      const res = await fetch(reqUrl, {
        ...
        headers: (() => {
          ...
          if (!isNewInference) {
            headers.delete("x-orchium-session")
            headers.delete("x-orchium-project")
            headers.delete("x-orchium-client")
            headers.delete("x-orchium-request")
      ...
      if (isNewInference) {
        const resEndpointId = res.headers.get("x-orchium-endpoint-id")
        const resEndpointModelId = res.headers.get("x-orchium-upstream-model-id")
