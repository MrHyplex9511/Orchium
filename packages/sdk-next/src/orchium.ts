import { Orchium } from "@orchium/client/effect"
...
import { createEmbeddedRoutes } from "@orchium/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("Orchium.create")(function* () {
  ...
  const client = yield* Orchium.make({ baseUrl: "http://orchium.local" }).pipe(
...
export class Service extends Context.Service<Service, Interface>()("@orchium/sdk-next/Orchium") {}
