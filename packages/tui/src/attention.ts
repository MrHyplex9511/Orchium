...
import defaultSoundPath from "@orchium/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@orchium/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@orchium/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@orchium/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@orchium/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@orchium/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "orchium"
const DEFAULT_PACK_ID = "orchium.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Orchium Default",
  builtin: true,
  sounds: {
