...
import { registerOrchiumSpinner } from "../register-spinner"
...
import type { AssistantMessage, FilePart, UserMessage } from "@orchium/sdk/v2"
...
import { ORCHIUM_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useOrchiumKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.ORCHIUM_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
