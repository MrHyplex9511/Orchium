...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "ORCHIUM.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/orchium/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/orchium (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/orchium/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/orchium/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const ORCHIUM_DB|ORCHIUM_DB|ORCHIUM_DEV|Global\\.Path\\.data|data =" in packages/orchium/src (115 matches)',
  },
] as const
