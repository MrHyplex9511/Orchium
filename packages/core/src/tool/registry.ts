...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@orchium/llm"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/v2/ToolRegistry") {}
