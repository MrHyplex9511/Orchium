...
import { Entry, FileSystem, FindInput, Match } from "@orchium/schema/filesystem"
export { Entry, Match, Submatch } from "@orchium/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/v2/FileSystem") {}
