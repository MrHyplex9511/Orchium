...
import type { IntegrationOAuthMethodRegistration } from "@orchium/plugin/v2/effect/integration"
import { define } from "@orchium/plugin/v2/effect/plugin"
...
function headers(contentType: string) {
  return { "Content-Type": contentType, "User-Agent": `orchium/${InstallationVersion}` }
}
