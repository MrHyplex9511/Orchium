...
import type { Data, Definition, Payload } from "@orchium/schema/event"
...
import { Durable } from "@orchium/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@orchium/schema/event").ID
export type { Data, Definition, Payload } from "@orchium/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/Event") {}
