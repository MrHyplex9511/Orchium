...
import { Event } from "@orchium/schema/project-directories"
import { ProjectCopy } from "@orchium/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/ProjectCopy") {}
