...
import type { EffectDrizzleSqlite } from "@orchium/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@orchium/ProjectDirectories") {}
