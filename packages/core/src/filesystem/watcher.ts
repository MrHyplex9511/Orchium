...
import { FileSystemWatcher } from "@orchium/schema/filesystem-watcher"
...
declare const ORCHIUM_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof ORCHIUM_LIBC === "undefined" ? undefined : ORCHIUM_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@orchium/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.ORCHIUM_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.ORCHIUM_EXPERIMENTAL_FILEWATCHER)) {
