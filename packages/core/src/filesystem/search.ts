...
export class Service extends Context.Service<Service, Interface>()("@orchium/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.ORCHIUM_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
