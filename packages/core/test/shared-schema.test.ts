...
import { AgentAttachment, FileAttachment, Prompt, Source } from "@orchium/schema/prompt"
import { Provider } from "@orchium/schema/provider"
import { Project } from "@orchium/schema/project"
import { ProjectDirectories } from "@orchium/schema/project-directories"
import { PermissionV1 } from "@orchium/schema/permission-v1"
...
import { Command } from "@orchium/schema/command"
import { Connection } from "@orchium/schema/connection"
import { Credential } from "@orchium/schema/credential"
import { FileSystem } from "@orchium/schema/filesystem"
import { Integration } from "@orchium/schema/integration"
import { LLM } from "@orchium/schema/llm"
import { Permission } from "@orchium/schema/permission"
import { Plugin } from "@orchium/schema/plugin"
import { Pty } from "@orchium/schema/pty"
import { Reference } from "@orchium/schema/reference"
import { SessionTodo } from "@orchium/schema/session-todo"
import { Skill } from "@orchium/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@orchium/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@orchium/core/command"),
    import("@orchium/core/integration/connection"),
    import("@orchium/core/credential"),
    import("@orchium/core/filesystem"),
    import("@orchium/core/integration"),
    import("@orchium/core/location"),
    import("@orchium/llm"),
    import("@orchium/core/permission"),
    import("@orchium/core/v1/permission"),
    import("@orchium/core/project/copy"),
    import("@orchium/core/pty"),
    import("@orchium/core/project/schema"),
    import("@orchium/core/reference"),
    import("@orchium/core/session/input"),
    import("@orchium/core/session/message"),
    import("@orchium/core/session/todo"),
    import("@orchium/core/session/prompt"),
    import("@orchium/core/skill"),
    import("@orchium/core/v2-schema"),
    import("@orchium/core/schema"),
    import("@orchium/core/workspace"),
  ])
