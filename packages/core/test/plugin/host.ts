import type { PluginContext } from "@orchium/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@orchium/sdk/v2/types"
