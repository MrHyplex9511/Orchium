...
import { registerOrchiumTheme } from "@orchium/ui/context/marked-theme-register"

registerOrchiumTheme()
  ...
  const pool = new WorkerPoolManager(
    {
      ...
      // NOTE: 2 is probably better for Orchium, as I think 8 might be
