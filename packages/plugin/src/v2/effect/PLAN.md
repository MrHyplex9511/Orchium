...
- Effect plugins import `@orchium/plugin/v2/effect`, not `@orchium/core`.
- Public domain values use generated `@orchium/sdk` types.
...
- Define `PluginHost` domain capabilities in `@orchium/plugin/v2/effect`.
