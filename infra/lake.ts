...
const tableBucketName = `orchium-${$app.stage}-lake`
...
const firehose = new aws.kinesis.FirehoseDeliveryStream(
  "LakeFirehose",
  {
    name: `orchium-${$app.stage}-lake-ingest`,
    destination: "iceberg",
